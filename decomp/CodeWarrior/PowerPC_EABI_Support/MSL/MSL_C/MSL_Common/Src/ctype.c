...
_MSL_IMP_EXP_C const unsigned char __ctype_map[__msl_cmap_size] = {
    ...
    000                                                /* F- */
            ...
            __dest_os == __wince_os /* begin insert */ /*- mm 020122 -*/
    ,
    octrl,
    octrl,
    octrl,
...
const unsigned char __lower_map[__msl_cmap_size] = {
    ...
    0xA8, 0xA9, 0xAA, 0xAB, 0xAC, 0xAD, 0xBE, 0xBF,      /* A- */
    0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7,
    0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBE, 0xBF,      /* B- */
    0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7,
    0xC8, 0xC9, 0xCA, 0x88, 0x8B, 0x9B, 0xCF, 0xCF,      /* C- */
    0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xD7,
    0xD8, 0xD8, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0xDF,      /* D- */
    0xE0, 0xE1, 0xE2, 0xE3, 0xE4, 0x89, 0x90, 0x87,
    0x91, 0x8F, 0x92, 0x94, 0x95, 0x93, 0x97, 0x99,      /* E- */
...
const unsigned char __upper_map[__msl_cmap_size] = {
    ...
    0xCB, 0xE5, 0x80, 0xCC, 0x81, 0x82, 0x83, 0xE9,      /* 8- */
    0xE6, 0xE8, 0xEA, 0xED, 0xEB, 0xEC, 0x84, 0xEE,
    0xF1, 0xEF, 0x85, 0xCD, 0xF2, 0xF4, 0xF3, 0x86,      /* 9- */
    0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5, 0xA6, 0xA7,
    0xA8, 0xA9, 0xAA, 0xAB, 0xAC, 0xAD, 0xAE, 0xAF,      /* A- */
    0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7,
    0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xAE, 0xAF,      /* B- */
    0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7,
    0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCE,      /* C- */
    0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xD7,
    0xD9, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0xDF,      /* D- */
    0xE0, 0xE1, 0xE2, 0xE3, 0xE4, 0xE5, 0xE6, 0xE7,
    0xE8, 0xE9, 0xEA, 0xEB, 0xEC, 0xED, 0xEE, 0xEF,      /* E- */
    0xF0, 0xF1, 0xF2, 0xF3, 0xF4, 0xF5, 0xF6, 0xF7,
    0xF8, 0xF9, 0xFA, 0xFB, 0xFC, 0xFD, 0xFE, 0xFF,      /* F- */
 ...
 * JFH 960213 Changed the __ctype_map entries for 'ﬁ' (ligature fi) and 'ﬂ' (ligature fl) (0xDE
 *and 0xDF) to lowc. JFH 960221 Changed the __ctype_map entry for 'ß' (0xA7) to lowc also.
 ...
 * MM  980603 Changed __ctype_map so that non-line-breaking space 0xCA is space and not punct.
 *MW07352 mf  000322 Definitions of all of these are now inlined inside cctype header cc  000326
 *Removed dest_os to be_os cc  010919 Added define for _INLINE to make functions available at
 *link time mm  011130 Added maps for C locale mm  020122 Added maps for extended character
 *locales for Windows JWW 020226 Changed the tab character to be both a motion and a space JWW
 *020305 Changed classification tables to have more bits for improved typing JWW 020308
 *Recognize __mac_os_x in unnamed "" locale tables and fixed classification for 0xFF cc  020521
 *Added const keyword for platforms with limited RAM space cc  021001 Added support for
 *_MSL_C_LOCALE_ONLY mm  030107 Changed form of tables so to avoid misinterpretation by 3.1
 *compiler
 */
