...
char* _MSL_CDECL
strdup (const char* str) _MSL_CANT_THROW
{
    return __msl_strdup (str);
}

char* _MSL_CDECL
strlwr (char* string) _MSL_CANT_THROW
{
    char* s = string;
...
char* _MSL_CDECL
ultoa (unsigned long val, char* str, int radix) _MSL_CANT_THROW
{
...
char* _MSL_CDECL
gcvt (double value, int digits, char* buffer) _MSL_CANT_THROW
{
...
int _MSL_CDECL
stricmp (const char* s1, const char* s2) _MSL_CANT_THROW
{
    char c1, c2;
    while (1)
    {
...
int _MSL_CDECL
strnicmp (const char* s1, const char* s2, size_t n) _MSL_CANT_THROW
{
...
/* Uppercase a string */
char* _MSL_CDECL
strupr (char* str) _MSL_CANT_THROW
{
...
char* _MSL_CDECL
strdate (char* str) _MSL_CANT_THROW
{
    time_t timer;
    time (&timer);
...
char* _MSL_CDECL
strset (char* str, int c) _MSL_CANT_THROW
{
    char* save = str;
...
char* _MSL_CDECL
strnset (char* str, int c, size_t n) _MSL_CANT_THROW
{
    char* save = str;
...
char* _MSL_CDECL
strspnp (char* s1, const char* s2) _MSL_CANT_THROW
{
    int len;               /*- mm 020906 -*/
...
int _MSL_CDECL
strncasecmp (const char* s1, const char* s2, size_t n) _MSL_CANT_THROW
{
    return __msl_strnicmp (s1, s2, n);
}

int _MSL_CDECL
strcmpi (const char* s1, const char* s2) _MSL_CANT_THROW
{
    return stricmp (s1, s2);
}

int _MSL_CDECL
strncmpi (const char* s1, const char* s2, size_t n) _MSL_CANT_THROW
{
    return __msl_strnicmp (s1, s2, n);
}

int _MSL_CDECL
strcasecmp (const char* s1, const char* s2) _MSL_CANT_THROW
{
    return stricmp (s1, s2);
}

int _MSL_CDECL
stricoll (const char* s1, const char* s2) _MSL_CANT_THROW
{
    return stricmp (s1, s2);
}

int _MSL_CDECL
strncoll (const char* s1, const char* s2, __std (size_t) sz) _MSL_CANT_THROW
{
    return strncmp (s1, s2, sz);
}

int _MSL_CDECL
strnicoll (const char* s1, const char* s2, __std (size_t) sz) _MSL_CANT_THROW
{
    return strnicmp (s1, s2, sz);
}

char* _MSL_CDECL
itoa (int val, char* str, int radix) _MSL_CANT_THROW
{
...
char* _MSL_CDECL
strrev (char* str) _MSL_CANT_THROW
{
...
int _MSL_CDECL
filelength (int fileno) _MSL_CANT_THROW
{
    struct stat st;
    if (fstat (fileno, &st))
        return -1;
...
int _MSL_CDECL
chsize (int handle, long size) _MSL_CANT_THROW
{
    FILE*       infile;
    struct stat buff;
    int         status;
...
int _MSL_CDECL
wtoi (const wchar_t* _a) _MSL_CANT_THROW
{
...
wchar_t* _MSL_CDECL
wcslwr (wchar_t* str) _MSL_CANT_THROW
{
    wchar_t* saved = str;
...
wchar_t* _MSL_CDECL
wcsupr (wchar_t* str) _MSL_CANT_THROW
{
    wchar_t* saved = str;
...
int _MSL_CDECL
wcsicmp (const wchar_t* s1, const wchar_t* s2) _MSL_CANT_THROW
{
    wchar_t c1, c2;
    while (1)
    {
...
int _MSL_CDECL
wcsnicmp (const wchar_t* s1, const wchar_t* s2, size_t n) _MSL_CANT_THROW
{
    int     i;
    wchar_t c1, c2;
    for (i = 0; i < n; i++)
...
wchar_t* _MSL_CDECL
wcsrev (wchar_t* str) _MSL_CANT_THROW
{
    int SmallIndex = 0;
...
wchar_t* _MSL_CDECL
wcsset (wchar_t* str, wchar_t wc) _MSL_CANT_THROW
{
    wchar_t* saved = str;
...
wchar_t* _MSL_CDECL
wcsnset (wchar_t* str, wchar_t wc, size_t n) _MSL_CANT_THROW
{
    wchar_t* saved = str;
...
/* return pointer to first character in s1 that isn't in s2 */
wchar_t* _MSL_CDECL
wcsspnp (const wchar_t* s1, const wchar_t* s2) _MSL_CANT_THROW
{
    int len;                           /*- mm 020906 -*/
...
wchar_t* _MSL_CDECL
wcsdup (const wchar_t* str) _MSL_CANT_THROW
{
...
wchar_t* _MSL_CDECL
wstrrev (wchar_t* str) _MSL_CANT_THROW
{
    int SmallIndex = 0;
    int BigIndex   = wcslen (str) - 1;
...
int _MSL_CDECL
wcsicoll (const wchar_t* s1, const wchar_t* s2) _MSL_CANT_THROW
{
    return wcsicmp (s1, s2);
}

int _MSL_CDECL
wcsncoll (const wchar_t* s1, const wchar_t* s2, __std (size_t) sz) _MSL_CANT_THROW
{
    return wcsncmp (s1, s2, sz);
}

int _MSL_CDECL
wcsnicoll (const wchar_t* s1, const wchar_t* s2, __std (size_t) sz) _MSL_CANT_THROW
{
    return wcsnicmp (s1, s2, sz);
}

wchar_t* _MSL_CDECL
itow (int val, wchar_t* str, int radix) _MSL_CANT_THROW
{
    char         IsNegative = 0;
    int          theNum     = val;
...
double _MSL_CDECL
watof (const wchar_t* str) _MSL_CANT_THROW
{
...
char* _MSL_CDECL
asctime_r (const struct tm* tm, char* s) _MSL_CANT_THROW
{
...
char* _MSL_CDECL
ctime_r (const time_t* timer, char* s) _MSL_CANT_THROW
{
    return (asctime_r (localtime (timer), s));
}

struct tm* _MSL_CDECL
localtime_r (const time_t* timer, struct tm* tm) _MSL_CANT_THROW
{
    return localtime_s (timer, tm);
}

struct tm* _MSL_CDECL
gmtime_r (const time_t* timer, struct tm* tm) _MSL_CANT_THROW
{
...
int _MSL_CDECL
rand_r (unsigned int* context) _MSL_CANT_THROW
{
...
int _MSL_CDECL
strerror_r (int errnum, char* str, size_t buflen) _MSL_CANT_THROW
{
...
char* _MSL_CDECL
strtok_r (char* _MSL_RESTRICT str, const char* _MSL_RESTRICT set, char** _MSL_RESTRICT ptr)
{
    return strtok_s (str, set, ptr);
        ...
        * mm  010116 Changes to make _strupr return pointer to beginning of string instead of end.
        *Josef's fix.        cc  010130 Changed _splitpath to support UNC pathnames        mm  010412 Avoided setting
        *errno to negative value.        cc  010605 Made _itoa call __msl_itoa, _strrev call __msl_strrev,
        *_itoa call __msl_itoa,and        _strnicmp call __msl_strnicmp        cc  010605 Added #include of file_io.h
        ...
        * cc  040204 The _No_Time_OS_Support flag has been deprecated and replaced with
        *_MSL_OS_TIME_SUPPORT        cc  040217 Changed _No_Floating_Point to _MSL_FLOATING_POINT        cc  040217
        *Changed _No_Disk_File_OS_Support to _MSL_OS_DISK_FILE_SUPPORT
        */
