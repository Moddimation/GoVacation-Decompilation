...
template <class T, class traits>
inline _RefCountedPtr<T, traits>::_RefCountedPtr (const _RefCountedPtr<T, traits>& other)
    _MSL_NO_THROW : ptr_ (other.ptr_),
...
template <class T, class traits>
inline _RefCountedPtr<T, traits>::operator const T * () const _MSL_NO_THROW
{
    return ptr_;
}
