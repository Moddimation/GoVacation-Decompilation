...
_MSL_IMP_EXP_C long double _MSL_MATH_CDECL
erfl (long double x) _MSL_CANT_THROW
{
    return ((long double)erf (x));         /*- cc 060303 -*/
}

_MSL_IMP_EXP_C long double _MSL_MATH_CDECL
erfcl (long double x) _MSL_CANT_THROW
{
    return ((long double)(1.0 - erf (x))); /*- cc 060303 -*/
}

_MSL_IMP_EXP_C long double _MSL_MATH_CDECL
exp2l (long double x) _MSL_CANT_THROW
{
...
_MSL_IMP_EXP_C long double _MSL_MATH_CDECL
lgammal (long double x) _MSL_CANT_THROW
{
    return (logl (tgammal (x)));
}

_MSL_IMP_EXP_C long double _MSL_MATH_CDECL
nanl (const char* str) _MSL_CANT_THROW
{
    char temparg[32] = "NAN(";
    strcat (temparg, str);
    strcat (temparg, ")");
...
_MSL_IMP_EXP_C long double _MSL_MATH_CDECL
tgammal (long double x) _MSL_CANT_THROW
{
    long double coefs[26] = { +1.0000000000000000, +0.5772156649915329, -0.6558780715202538,
                              ...
                              +0.0000000061160960, +0.0000000050020075, -0.0000000011812746,
    ...
    return (1.0 / div);
                                            ...
                                            *_MSL_FLOATING_POINT flag check                                            cc  040518 File has been split                                            cc  060303 Using suns erf
                                            */
