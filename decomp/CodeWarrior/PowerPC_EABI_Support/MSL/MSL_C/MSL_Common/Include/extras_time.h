...
_MSL_IMP_EXP_C struct __std (tm) * _MSL_CDECL
    localtime_r (const __std (time_t) *, struct __std (tm) *) _MSL_CANT_THROW;
_MSL_IMP_EXP_C char* _MSL_CDECL strdate (char*) _MSL_CANT_THROW;
_MSL_IMP_EXP_C struct __std (tm) * _MSL_CDECL
    gmtime_r (const __std (time_t) *, struct __std (tm) *) _MSL_CANT_THROW;
