...
int16_t _MSL_CDECL
strtosfix16 (const char* str, char** endptr)
{
...
int32_t _MSL_CDECL
strtosfix32 (const char* str, char** endptr)
{
...
int64_t _MSL_CDECL
strtosfix64 (const char* str, char** endptr)
{
    long double d = strtold (str, endptr);
    if (d >= SFIXED_MAX)
    {
...
uint16_t _MSL_CDECL
strtoufix16 (const char* str, char** endptr)
{
    double d = strtod (str, endptr);
    if (d >= UFIXED_MAX)
    {
...
uint32_t _MSL_CDECL
strtoufix32 (const char* str, char** endptr)
{
    long double d = strtold (str, endptr);
    if (d >= UFIXED_MAX)
    {
...
uint64_t _MSL_CDECL
strtoufix64 (const char* str, char** endptr)
{
    long double d = strtold (str, endptr);
    if (d >= UFIXED_MAX)
    {
