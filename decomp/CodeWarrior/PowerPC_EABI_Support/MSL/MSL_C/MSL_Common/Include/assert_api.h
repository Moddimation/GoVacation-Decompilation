...
_MSL_IMP_EXP_C void _MSL_CDECL __msl_wchar_assertion_failed (wchar_t const *,
                                                             char const *,
                                                             char const *,
                                                             int) _MSL_CANT_THROW;
    #endif

_MSL_IMP_EXP_C void _MSL_CDECL __msl_assertion_failed (char const *,
                                                       char const *,
                                                       char const *,
                                                       int) _MSL_CANT_THROW;
