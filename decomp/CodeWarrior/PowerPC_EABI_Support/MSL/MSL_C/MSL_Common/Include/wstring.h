...
_MSL_IMP_EXP_C wchar_t*            _MSL_CDECL (wcscpy) (wchar_t*       _MSL_RESTRICT,
                                             const wchar_t* _MSL_RESTRICT) _MSL_CANT_THROW;
_MSL_IMP_EXP_C wchar_t* _MSL_CDECL wcsncpy (wchar_t*       _MSL_RESTRICT,
                                            const wchar_t* _MSL_RESTRICT,
                                            size_t) _MSL_CANT_THROW;
_MSL_IMP_EXP_C wchar_t* _MSL_CDECL wcscat (wchar_t*       _MSL_RESTRICT,
                                           const wchar_t* _MSL_RESTRICT) _MSL_CANT_THROW;
_MSL_IMP_EXP_C wchar_t* _MSL_CDECL wcsncat (wchar_t*       _MSL_RESTRICT,
                                            const wchar_t* _MSL_RESTRICT,
                                            size_t) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C size_t _MSL_CDECL   wcsxfrm (wchar_t*       _MSL_RESTRICT,
                                            const wchar_t* _MSL_RESTRICT,
                                            size_t) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C wchar_t* _MSL_CDECL wcstok (wchar_t*       _MSL_RESTRICT,
                                           const wchar_t* _MSL_RESTRICT,
                                           wchar_t**      _MSL_RESTRICT)
    _MSL_CANT_THROW; /*- mm 000420 -*/
...
_MSL_IMP_EXP_C const wchar_t* _MSL_CDECL wcspbrk (const wchar_t*,
                                                  const wchar_t*) _MSL_CANT_THROW;
_MSL_IMP_EXP_C const wchar_t* _MSL_CDECL wcsrchr (const wchar_t*, wchar_t) _MSL_CANT_THROW;
_MSL_IMP_EXP_C const wchar_t* _MSL_CDECL wcsstr (const wchar_t*,
                                                 const wchar_t*) _MSL_CANT_THROW;
    #endif

    #if defined(__STDC_WANT_LIB_EXT1__) && __STDC_WANT_LIB_EXT1__
_MSL_IMP_EXP_C size_t  _MSL_CDECL (wcsnlen_s) (const wchar_t*, size_t) _MSL_CANT_THROW;
_MSL_IMP_EXP_C errno_t _MSL_CDECL (wcscpy_s) (wchar_t* _MSL_RESTRICT,
                                              rsize_t,
                                              const wchar_t* _MSL_RESTRICT) _MSL_CANT_THROW;
_MSL_IMP_EXP_C errno_t _MSL_CDECL wcsncpy_s (wchar_t* _MSL_RESTRICT,
                                             rsize_t,
                                             const wchar_t* _MSL_RESTRICT,
                                             rsize_t) _MSL_CANT_THROW;
_MSL_IMP_EXP_C errno_t _MSL_CDECL wcscat_s (wchar_t* _MSL_RESTRICT,
                                            rsize_t,
                                            const wchar_t* _MSL_RESTRICT) _MSL_CANT_THROW;
_MSL_IMP_EXP_C errno_t _MSL_CDECL wcsncat_s (wchar_t* _MSL_RESTRICT,
                                             rsize_t,
                                             const wchar_t* _MSL_RESTRICT,
                                             rsize_t) _MSL_CANT_THROW;
