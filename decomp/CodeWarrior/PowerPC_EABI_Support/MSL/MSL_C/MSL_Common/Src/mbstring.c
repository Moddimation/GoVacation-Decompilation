...
int
__utf8_to_unicode (wchar_t* pwc, const char* s, size_t n) /*- mm 011130 -*/
{
...
int _MSL_CDECL
mbtowc (wchar_t* _MSL_RESTRICT pwc, const char* _MSL_RESTRICT s, size_t n)
{
    return (_MSL_LOCALDATA (_current_locale)
                .ctype_cmpt_ptr->decode_mb (pwc, s, n)); /*- mm 020119 -*/
}

int
__unicode_to_UTF8 (char* _MSL_RESTRICT s, wchar_t wchar) /*- mm 011130 -*/
{
    int     number_of_bytes;
    wchar_t wide_char;
    char*   target_ptr;
...
int
__unicode_to_UTF8_s (char* _MSL_RESTRICT s, size_t smax, wchar_t wchar) /*- mm 011130 -*/
{
    int     number_of_bytes;
    wchar_t wide_char;
    char*   target_ptr;
...
int
__mbtowc_noconv (wchar_t* pwc, const char* s, size_t n)
{
    if (!s)
        return (0);
...
int
__wctomb_noconv (char* s, wchar_t wchar)
{
    if (!s)
        return (0);
...
{
    return (_MSL_LOCALDATA (_current_locale)
                .ctype_cmpt_ptr->encode_wc (s, wchar)); /*- mm 020119 -*/
}

int _MSL_CDECL
wctomb_s (int* _MSL_RESTRICT status, char* _MSL_RESTRICT s, rsize_t smax, wchar_t wchar)
{
    int  newstatus;
    int  len;
    char wc[MB_CUR_MAX];
...
size_t _MSL_CDECL
mbstowcs (wchar_t* _MSL_RESTRICT pwcs, const char* _MSL_RESTRICT s, size_t n)
{
    int    result;
    char*  source;
    int    count;
...
errno_t _MSL_CDECL
mbstowcs_s (size_t* _MSL_RESTRICT     retval,
            wchar_t* _MSL_RESTRICT    pwcs,
            rsize_t                   pwcsmax,
            const char* _MSL_RESTRICT s,
            rsize_t                   n)
{
    int    result;
    char*  source;
    ...
    if ((retval == NULL) || (s == NULL) ||
        ((pwcs != NULL) && ((pwcsmax > RSIZE_MAX) || (n > RSIZE_MAX) || (pwcsmax < n))))
    {
        __msl_runtime_constraint_violation_s (NULL, NULL, ERANGE);
        if (retval != NULL)
            *retval = (size_t)-1;
...
size_t _MSL_CDECL
wcstombs (char* _MSL_RESTRICT s, const wchar_t* _MSL_RESTRICT pwcs, size_t n)
{
    int      chars_written = 0;
    int      result;
...
errno_t _MSL_CDECL
wcstombs_s (size_t* _MSL_RESTRICT        retval,
            char* _MSL_RESTRICT          s,
            rsize_t                      s_max,
            const wchar_t* _MSL_RESTRICT pwcs,
            rsize_t                      n)
{
    int      chars_written = 0;
    int      result;
    ...
    if ((retval == NULL) || (pwcs == NULL) ||
        ((s != NULL) && ((s_max > RSIZE_MAX) || (n > RSIZE_MAX) || (s_max < n))))
    {
        __msl_runtime_constraint_violation_s (NULL, NULL, ERANGE);
        if (retval != NULL)
            *retval = (size_t)-1;
    ...
    *retval = chars_written;
    ...
    #if _MSL_C99                                              /*- mm 030304 -*/
size_t _MSL_CDECL
mbrlen (const char* _MSL_RESTRICT s, size_t n, mbstate_t* _MSL_RESTRICT ps)
{
        #pragma unused(ps)
...
size_t _MSL_CDECL
mbrtowc (wchar_t* _MSL_RESTRICT    pwc,
         const char* _MSL_RESTRICT s,
         size_t                    n,
         mbstate_t* _MSL_RESTRICT  ps)
{
        #pragma unused(ps)
    size_t num_of_chars;
...
size_t _MSL_CDECL
wcrtomb (char* _MSL_RESTRICT s, wchar_t wc, mbstate_t* _MSL_RESTRICT ps)
{
        #pragma unused(ps)
...
errno_t _MSL_CDECL
wcrtomb_s (size_t* _MSL_RESTRICT    retval,
           char* _MSL_RESTRICT      s,
           rsize_t                  smax,
           wchar_t                  wc,
           mbstate_t* _MSL_RESTRICT ps)
...
size_t _MSL_CDECL
mbsrtowcs (wchar_t* _MSL_RESTRICT     dst,
           const char** _MSL_RESTRICT src,
           size_t                     len,
           mbstate_t* _MSL_RESTRICT   ps)
{
    int     result;
...
errno_t _MSL_CDECL
mbsrtowcs_s (size_t* _MSL_RESTRICT      retval,
             wchar_t* _MSL_RESTRICT     dst,
             rsize_t                    dstmax,
             const char** _MSL_RESTRICT src,
             rsize_t                    len,
             mbstate_t* _MSL_RESTRICT   ps)
{
    ...
    if ((retval == NULL) || (src == NULL) || (*src == NULL) || (ps == NULL) ||
        ((dst != NULL) && ((len > RSIZE_MAX) || (dstmax > RSIZE_MAX) || (dstmax < len))))
    {
        __msl_runtime_constraint_violation_s (NULL, NULL, ERANGE);
        if (retval != NULL)
            *retval = (size_t)-1;
...
size_t _MSL_CDECL
wcsrtombs (char* _MSL_RESTRICT           dst,
           const wchar_t** _MSL_RESTRICT src,
           size_t                        len,
           mbstate_t* _MSL_RESTRICT      ps)
{
    int      chars_written = 0;
...
errno_t _MSL_CDECL
wcsrtombs_s (size_t* _MSL_RESTRICT         retval,
             char* _MSL_RESTRICT           dst,
             rsize_t                       dstmax,
             const wchar_t** _MSL_RESTRICT src,
             rsize_t                       len,
             mbstate_t* _MSL_RESTRICT      ps)
...
/*- mm 021210 -*/
        ...
        * implementation.  Thanks to E. Cloninger        mm  010528 Complete rewrite to implement UTF-8 as the
        * encoding for multibyte        mm  010607 Fixes to UTF-8 conversion        mm  011102 Corrects return value
        * of mbstowcs when multibyte string is invalid        mm  011130 Changes for implementation of locale
        ...
        * mm  021112 Moved a return statement out of the loop in is_utf8_complete to fix a termination
        * bug        mm  021210 Added mbsinit()        JWW 030224 Changed __NO_WIDE_CHAR flag into the new more
        * configurable _MSL_WIDE_CHAR        mm  030304 Added _MSL_C99 wrappers        mm  030401 correction to
        * prevent sign extension when assigning char to wchar
        */
