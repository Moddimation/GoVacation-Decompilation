...
void _MSL_CDECL
__msl_runtime_constraint_violation_s (const char* _MSL_RESTRICT msg,
                                      void* _MSL_RESTRICT       ptr,
                                      errno_t                   error)
{
...
constraint_handler_t _MSL_CDECL
...
void _MSL_CDECL
abort_handler_s (const char* _MSL_RESTRICT msg, void* _MSL_RESTRICT ptr, errno_t error)
{
#pragma unused(ptr)
...
void _MSL_CDECL
ignore_handler_s (const char* _MSL_RESTRICT msg, void* _MSL_RESTRICT ptr, errno_t error)
{
#pragma unused(msg, ptr, error)
}

void _MSL_CDECL
strict_handler_s (const char* _MSL_RESTRICT msg, void* _MSL_RESTRICT ptr, errno_t error)
{
#pragma unused(ptr)
    ...
    if (msg)
       ...
       /* Change record:
        * JWW 050111 New file to handle diagnosed runtime constraint violations in secure library
        * routines
        */
