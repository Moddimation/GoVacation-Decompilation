...
struct lconv __lconv = {
    ...
    "" /* currency_symbol		*/,       CHAR_MAX /* frac_digits			*/,
    CHAR_MAX /* p_cs_precedes		*/, CHAR_MAX /* n_cs_precedes		*/,
    CHAR_MAX /* p_sep_by_space		*/, CHAR_MAX /* n_sep_by_space		*/,
    CHAR_MAX /* p_sign_posn			*/, CHAR_MAX /* n_sign_posn			*/,
    "" /* int_curr_symbol		*/,       CHAR_MAX /* int_frac_digits		*/,
    #if _MSL_C99                                  /*- mm 030528 -*/
    CHAR_MAX /* int_p_cs_precedes	*/, CHAR_MAX /* int_n_cs_precedes	*/,
    CHAR_MAX /* int_p_sep_by_space	*/, CHAR_MAX /* int_n_sep_by_space	*/,
    CHAR_MAX /* int_p_sign_posn		*/, CHAR_MAX  /* int_n_sign_posn		*/
...
struct _loc_ctype_cmpt _loc_ctyp_I = { "",              /*- mm 020108 -*/
...
struct _loc_ctype_cmpt _loc_ctyp_C_UTF_8 = { "C-UTF-8", /*- mm 020108 -*/
                                             (unsigned short*)&__ctype_mapC[0],
                                             (unsigned char*)&__upper_mapC[0],
                                             (unsigned char*)&__lower_mapC[0],
    #if _MSL_WIDE_CHAR
...
unsigned short char_coll_tableC[0x60] =
    /* begin rewrite of C locale collate table */ /*- 040525 -*/
...
#if !_MSL_C_LOCALE_ONLY
    "C",
    /* component name     	*/                   /*- mm 020718 -*/
#endif
    0x20,
    /* char_start_value  	*/ /*- mm 020718 -*/ /*- 040525 -*/
    0x6e,
    /* char_coll_tab_size	*/ /*- mm 020718 -*/ /*- 040525 -*/
    0,
    /* char_spec_accents    */                   /*- mm 020718 -*/
    (unsigned short*)&char_coll_tableC[0],
    /* char_coll_table_ptr	*/                   /*- mm 020718 -*/
#if !_MSL_C_LOCALE_ONLY
...
setlocale (int category, const char* locale)
{
    ...
    int              cmpt_macro_vals[_LOCALE_CMPT_COUNT] = { LC_COLLATE,
                                                             LC_CTYPE,
                                                             LC_MONETARY,
                                                             LC_NUMERIC,
                                                             LC_TIME };
        ...
        else
        {
            switch (category)
            {
                case LC_ALL:
                    ...
                    memcpy ((void*)&_MSL_LOCALDATA (__lconv).mon_decimal_point,
                            (void*)&(locptr->mon_cmpt_ptr)->mon_decimal_point,
                            sizeof (struct _loc_mon_cmpt_vals));
                    memcpy ((void*)&_MSL_LOCALDATA (__lconv).decimal_point,
...
/* The following is a modified version  of fgets, to handle the differing line endings MacOS,
 * MachO, and Windows */ 	/*- mm 020911 -*/
static char* xfgets (char* s, int n, FILE* stream);

static char*
xfgets (char* s, int n, FILE* stream)
{
    char* p = s;
    int   c;
...
BuildLocale (const char* locale)
{
    ...
    int  value_elements[11] = { __msl_alpha, __msl_blank, __msl_cntrl, __msl_digit,
                                __msl_graph, __msl_lower, __msl_print, __msl_punct,
                                __msl_space, __msl_upper, __msl_xdigit };
    ...
    while (locptr->next_locale != NULL) locptr = locptr->next_locale;
            ...
            case ctype_narrow:
                {
                    if (NewLocale->ctype_cmpt_ptr == _preset_locales[0].ctype_cmpt_ptr)
                    {
                        ...
                        NewLocale->ctype_cmpt_ptr->ctype_map_ptr =
                            _loc_ctyp_C.ctype_map_ptr;               /*- mm 020617 -*/
                        NewLocale->ctype_cmpt_ptr->upper_map_ptr =
                            _loc_ctyp_C.upper_map_ptr;               /*- mm 020617 -*/
                        NewLocale->ctype_cmpt_ptr->lower_map_ptr =
                            _loc_ctyp_C.lower_map_ptr;               /*- mm 020617 -*/
        #if _MSL_WIDE_CHAR
            #if _MSL_C99                                             /*- mm 030321 -*/
                        NewLocale->ctype_cmpt_ptr->wctype_map_ptr =
                            _loc_ctyp_C.wctype_map_ptr;              /*- mm 020617 -*/
                        NewLocale->ctype_cmpt_ptr->wupper_map_ptr =
                            _loc_ctyp_C.wupper_map_ptr;              /*- mm 020617 -*/
                        NewLocale->ctype_cmpt_ptr->wlower_map_ptr =
                            _loc_ctyp_C.wlower_map_ptr;              /*- mm 020617 -*/
            #endif /* _MSL_C99 */                                    /*- mm 030321 -*/
                        NewLocale->ctype_cmpt_ptr->decode_mb =
                            _loc_ctyp_C.decode_mb;                   /*- mm 020617 -*/
                        NewLocale->ctype_cmpt_ptr->encode_wc =
                            _loc_ctyp_C.encode_wc;                   /*- mm 020617 -*/
        #endif                                                       /* _MSL_WIDE_CHAR */
                        continue;
                    }
                    ...
                    if (strcmp (id, "ctype") == 0)
                    {
                        if (state == ctype_narrow)
                        {
                            if (NewLocale->ctype_cmpt_ptr->ctype_map_ptr ==
                                _loc_ctyp_C.ctype_map_ptr)                /*- mm 020617 -*/
                                NewLocale->ctype_cmpt_ptr->ctype_map_ptr =
                                    malloc (sizeof (unsigned short[__msl_cmap_size]));
                        ...
                        if (state == ctype_wide)
                        {
                            if (NewLocale->ctype_cmpt_ptr->wctype_map_ptr ==
                                _loc_ctyp_C.wctype_map_ptr)               /*- mm 020617 -*/
                                NewLocale->ctype_cmpt_ptr->wctype_map_ptr =
                                    malloc (sizeof (wchar_t[__msl_wcmap_size]));
                        ...
                        while (chptr != NULL)
                        {
                            strcpy (token, chptr);
                            value |=
                                value_elements[(strstr (commands, token) - &commands[0]) / 6];
                    ...
                    else if (strcmp (id, "lower") == 0)
                    {
                        if (state == ctype_narrow)
                        {
                            if (NewLocale->ctype_cmpt_ptr->lower_map_ptr ==
                                _loc_ctyp_C.lower_map_ptr)                /*- mm 020617 -*/
                                NewLocale->ctype_cmpt_ptr->lower_map_ptr =
                                    malloc (sizeof (unsigned char[__msl_cmap_size]));
                        }
            ...
            case numeric_narrow:
                {
                    if (NewLocale->num_cmpt_ptr == _preset_locales[0].num_cmpt_ptr)
                    {
                        ...
                        NewLocale->num_cmpt_ptr->decimal_point =
                            _loc_num_C.decimal_point;                     /*- mm 020617 -*/
                        NewLocale->num_cmpt_ptr->thousands_sep =
                            _loc_num_C.thousands_sep;                     /*- mm 020617 -*/
                        NewLocale->num_cmpt_ptr->grouping =
                            _loc_num_C.grouping;                          /*- mm 020617 -*/
                        continue;
                    }
                    strcpy (id, strtok (line, " "));
                    if (*strtok (NULL, " ") != '=')
                            ...
                            case '\"':
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        NewLocale->coll_cmpt_ptr->char_coll_table_ptr =
                                            (unsigned short*)table_ptr;
                                        for (i = 0;
                                             i < NewLocale->coll_cmpt_ptr->char_coll_tab_size;
                                             i++)
            ...
            case time_narrow:
                {
                    ...
                    if (NewLocale->time_cmpt_ptr == _preset_locales[0].time_cmpt_ptr)
                    {
                        ...
                        NewLocale->time_cmpt_ptr->DateTime_Format =
                            _loc_tim_C.DateTime_Format;                     /*- mm 020617 -*/
                        NewLocale->time_cmpt_ptr->Twelve_hr_format =
                            _loc_tim_C.Twelve_hr_format;                    /*- mm 020617 -*/
                        NewLocale->time_cmpt_ptr->Date_Format =
                            _loc_tim_C.Date_Format;                         /*- mm 020617 -*/
                        NewLocale->time_cmpt_ptr->Time_Format =
                            _loc_tim_C.Time_Format;                         /*- mm 020617 -*/
                        NewLocale->time_cmpt_ptr->Day_Names =
                            _loc_tim_C.Day_Names;                           /*- mm 020617 -*/
                        NewLocale->time_cmpt_ptr->MonthNames =
                            _loc_tim_C.MonthNames;                          /*- mm 020617 -*/
                        NewLocale->time_cmpt_ptr->TimeZone =
                            _loc_tim_C.TimeZone;                            /*- mm 020617 -*/
                        continue;
                    }
                    strcpy (id, strtok (line, " "));
                    if (*strtok (NULL, " ") != '=')
                    ...
                    else if (strcmp (id, "am_pm") == 0)
                    {
                        ...
                        chptr = strtok (NULL, " ");
                        strcat (templine, chptr);
                        NewLocale->time_cmpt_ptr->am_pm =
                            malloc (strlen (templine) + 1);                 /*- mm 020731 -*/
                    ...
                    else if (strcmp (id, "time_12hour") == 0)
                    {
                        chptr = strtok (NULL, "\"");
                        NewLocale->time_cmpt_ptr->Twelve_hr_format =
                            malloc (strlen (chptr) + 1);                    /*- mm 020731 -*/
            ...
            case money_international_narrow:
                {
                    ...
                    if (state == money_local_narrow)
                    {
                        ...
                        {
                            NewLocale->mon_cmpt_ptr->mon_decimal_point =
                                malloc (strlen (token) + 1);                /*- mm 020731 -*/
                    ...
                    else
                    {
                        ...
                        else if ((strcmp (id, "pos_format") == 0) ||
