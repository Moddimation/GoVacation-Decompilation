...
_MSL_IMP_EXP_C int _MSL_CDECL          read (int,
                                             void*,
                                             __std (size_t)) _MSL_CANT_THROW;  /*- mm 000607 -*/
...
_MSL_IMP_EXP_C int _MSL_CDECL          write (int,
                                              const void*,
                                              __std (size_t)) _MSL_CANT_THROW; /*- mm 000607 -*/
    #endif
...
__inline int _MSL_CDECL
execl (const char* _a, ...) _MSL_CANT_THROW
{
    return exec (_a);
}

__inline int _MSL_CDECL
execv (const char* _a, ...) _MSL_CANT_THROW
{
    return exec (_a);
}

__inline int _MSL_CDECL
execle (const char* _a, ...) _MSL_CANT_THROW
{
    return exec (_a);
}

__inline int _MSL_CDECL
execve (const char* _a, ...) _MSL_CANT_THROW
{
    return exec (_a);
}

__inline int _MSL_CDECL
execlp (const char* _a, ...) _MSL_CANT_THROW
{
    return exec (_a);
}

__inline int _MSL_CDECL
execvp (const char* _a, ...) _MSL_CANT_THROW
{
    return exec (_a);
}
...
__inline int _MSL_CDECL
getppid (void) _MSL_CANT_THROW
{
    return 8000;
}

__inline int _MSL_CDECL
getuid (void) _MSL_CANT_THROW
{
    return 200;
}

__inline int _MSL_CDECL
geteuid (void) _MSL_CANT_THROW
{
    return 200;
}

__inline int _MSL_CDECL
getgid (void) _MSL_CANT_THROW
{
    return 100;
}

__inline int _MSL_CDECL
getegid (void) _MSL_CANT_THROW
{
    return 100;
}

__inline int _MSL_CDECL
getpgrp (void) _MSL_CANT_THROW
{
    return 9000;
}
