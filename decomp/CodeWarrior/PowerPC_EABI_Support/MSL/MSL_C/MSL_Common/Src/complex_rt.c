...
void inline complex_neg_templ (double* result, double* op)
{
    result[0] = -op[0];
    result[1] = -op[1];
}

void inline complex_add_templ (double* result, double* lhs, double* rhs)
{
    result[0] = lhs[0] + rhs[0];
    result[1] = lhs[1] + rhs[1];
}

void inline complex_sub_templ (double* result, double* lhs, double* rhs)
{
    result[0] = lhs[0] - rhs[0];
    result[1] = lhs[1] - rhs[1];
}
...
void
complex_mul_templ (double* result, double* rhs)
{
    double a  = result[0];
    double b  = result[1];
    double c  = rhs[0];
...
void
complex_div_templ (double* result, double* rhs)
{
    int    ilogbw = 0;
    double a      = result[0];
    double b      = result[1];
...
float*
__rt_cplx_neg_f (float* result, float* op)
{
    double dres[2], dop[2];
    dop[0] = op[0];
    dop[1] = op[1];
...
double*
__rt_cplx_neg_d (double* result, double* op)
{
...
long double*
__rt_cplx_neg_ld (long double* result, long double* op)
{
    double dres[2], dop[2];
    dop[0] = op[0];
    dop[1] = op[1];
...
float*
__rt_cplx_add_f (float* result, float* lhs, float* rhs)
{
...
double*
__rt_cplx_add_d (double* result, double* lhs, double* rhs)
{
...
long double*
__rt_cplx_add_ld (long double* result, long double* lhs, long double* rhs)
{
    double dres[2], dlhs[2], drhs[2];
    dlhs[0] = lhs[0];
    dlhs[1] = lhs[1];
...
float*
__rt_cplx_sub_f (float* result, float* lhs, float* rhs)
{
    double dres[2], dlhs[2], drhs[2];
    dlhs[0] = lhs[0];
    dlhs[1] = lhs[1];
...
double*
__rt_cplx_sub_d (double* result, double* lhs, double* rhs)
{
...
long double*
__rt_cplx_sub_ld (long double* result, long double* lhs, long double* rhs)
{
    double dres[2], dlhs[2], drhs[2];
    dlhs[0] = lhs[0];
    dlhs[1] = lhs[1];
...
float*
__rt_cplx_mul_f (float* result, float* lhs, float* rhs)
{
...
double*
__rt_cplx_mul_d (double* result, double* lhs, double* rhs)
{
    result[0] = lhs[0];
    result[1] = lhs[1];
...
long double*
__rt_cplx_mul_ld (long double* result, long double* lhs, long double* rhs)
{
    double dres[2], drhs[2];
    dres[0] = lhs[0];
    dres[1] = lhs[1];
...
float*
__rt_cplx_div_f (float* result, float* lhs, float* rhs)
{
    double dres[2], drhs[2];
    dres[0] = lhs[0];
    dres[1] = lhs[1];
...
double*
__rt_cplx_div_d (double* result, double* lhs, double* rhs)
{
    result[0] = lhs[0];
    result[1] = lhs[1];
...
long double*
__rt_cplx_div_ld (long double* result, long double* lhs, long double* rhs)
{
    double dres[2], drhs[2];
    dres[0] = lhs[0];
    dres[1] = lhs[1];
