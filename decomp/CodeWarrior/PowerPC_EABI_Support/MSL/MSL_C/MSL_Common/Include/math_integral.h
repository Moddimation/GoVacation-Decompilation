 ...
 */
    ...
    #if _MSL_FLOATING_POINT && !defined(_MSL_NO_MATH_LIB) && defined(__cplusplus) &&           \
        __embedded_cplusplus == 0 && defined(__ANSI_OVERLOAD__) &&                             \
        defined(_MSL_INTEGRAL_MATH) && !(__dest_os == __mac_os && defined(__FP__)) &&          \
        !defined(__m56800E__)
...
struct __msl_is_integral
{
    static const bool value = false;
        ...
        #if __option(bool)
template <>
struct __msl_is_integral<bool>
{
    static const bool value = true;
};
        #endif
template <>
struct __msl_is_integral<char>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<signed char>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<unsigned char>
{
    static const bool value = true;
};
        #if __option(wchar_type)
template <>
struct __msl_is_integral<wchar_t>
{
    static const bool value = true;
};
        #endif
template <>
struct __msl_is_integral<short>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<unsigned short>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<int>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<unsigned int>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<long>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<unsigned long>
{
    static const bool value = true;
};
        #if _MSL_LONGLONG
template <>
struct __msl_is_integral<long long>
{
    static const bool value = true;
};

template <>
struct __msl_is_integral<unsigned long long>
{
    static const bool value = true;
};
        #endif
...
template <class _T>
struct __msl_is_floating
{
    static const bool value = false;
};

template <>
struct __msl_is_floating<float>
{
    static const bool value = true;
};

template <>
struct __msl_is_floating<double>
{
    static const bool value = true;
};

template <>
struct __msl_is_floating<long double>
{
    static const bool value = true;
};

template <class _T>
struct __msl_is_arithmetic
{
    static const bool value = __msl_is_integral<_T>::value || __msl_is_floating<_T>::value;
};
...
template <class _T>
struct __msl_enable_if<true, _T>
{
    typedef _T type;
};
...
struct __msl_if<false, _If, _Then>
{
    typedef _Then type;
};
...
public:
    typedef
        typename __msl_if<__msl_is_arithmetic<_A1>::value,
...
template <class _A1>
inline typename __msl_enable_if<__msl_is_integral<_A1>::value, double>::type _MSL_MATH_CDECL
acos (_A1 x)
{
...
template <class _A1, class _A2>
inline
    typename __msl_enable_if<__msl_is_arithmetic<_A1>::value && __msl_is_arithmetic<_A2>::value,
                             typename __msl_promote<_A1, _A2>::type>::type _MSL_MATH_CDECL
    atan2 (_A1 x, _A2 y)
{
...
inline
    typename __msl_enable_if<__msl_is_arithmetic<_A1>::value &&
                                 __msl_is_arithmetic<_A2>::value &&
                                 __msl_is_arithmetic<_A3>::value,
                             typename __msl_promote<_A1, _A2, _A3>::type>::type _MSL_MATH_CDECL
...
template <class _A1>
inline typename __msl_enable_if<__msl_is_integral<_A1>::value, int>::type _MSL_MATH_CDECL
ilogb (_A1 x)
{
...
template <class _A1>
inline typename __msl_enable_if<__msl_is_integral<_A1>::value, long long>::type _MSL_MATH_CDECL
llrint (_A1 x)
{
...
template <class _A1>
inline typename __msl_enable_if<__msl_is_integral<_A1>::value, long>::type _MSL_MATH_CDECL
lrint (_A1 x)
{
