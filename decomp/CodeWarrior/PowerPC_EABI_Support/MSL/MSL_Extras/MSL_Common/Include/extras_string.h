...
_MSL_IMP_EXP_C int _MSL_CDECL   strncoll (const char*,
                                          const char*,
                                          __std (size_t)) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_CDECL   strnicoll (const char*,
                                           const char*,
                                           __std (size_t)) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_CDECL   strerror_r (int, char*, __std (size_t)) _MSL_CANT_THROW;
_MSL_IMP_EXP_C char* _MSL_CDECL strtok_r (char*       _MSL_RESTRICT,
                                          const char* _MSL_RESTRICT,
                                          char**      _MSL_RESTRICT) _MSL_CANT_THROW;
