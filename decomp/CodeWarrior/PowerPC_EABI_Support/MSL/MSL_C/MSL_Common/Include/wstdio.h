...
_MSL_IMP_EXP_C int _MSL_CDECL      fputws (const wchar_t* _MSL_RESTRICT,
                                           FILE*          _MSL_RESTRICT) _MSL_CANT_THROW;
_MSL_IMP_EXP_C wchar_t* _MSL_CDECL fgetws (wchar_t* _MSL_RESTRICT,
                                           int,
                                           FILE* _MSL_RESTRICT) _MSL_CANT_THROW;
