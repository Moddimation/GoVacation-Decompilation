...
_MSL_END_EXTERN_C
                               ...
                               * mm  010117 Replaced inline for open, create, & fcntl because one can't inline variable length
                               * argument lists.                               cc  000326 removed dest_os to be_os                               cc  010405 removed pragma options align
                               * native and reset                               cc  010409 updated defines to JWW new namespace macros                               JWW 010510 Removed
                               * special case for Mach-O - the cname/name.h header split is a better fix                               cc  011203 Added
                               * _MSL_CDECL for new name mangling                               JWW 021010 Added wchar_t file I/O routines controlled by
                               * _MSL_WFILEIO_AVAILABLE                               cc  021029 Added _No_Disk_File_OS_Support                               ejs 040108 Use <sys/stat.h>,
                               * not <stat.h>                               cc  040217 Changed _No_Disk_File_OS_Support to _MSL_OS_DISK_FILE_SUPPORT
                               */
