...
_MSL_IMP_EXP_C long double complex _MSL_CDECL cpowl (long double complex x,
...
/*#if _MSL_USE_INLINE*/
_MSL_INLINE _MSL_IMP_EXP_C double _MSL_CDECL
cimag (double complex z)
{
    return ((double*)&z)[1];
}

_MSL_INLINE _MSL_IMP_EXP_C float _MSL_CDECL
cimagf (float complex z)
{
    return ((float*)&z)[1];
}

_MSL_INLINE _MSL_IMP_EXP_C long double _MSL_CDECL
