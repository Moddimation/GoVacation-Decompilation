...
_MSL_BEGIN_NAMESPACE_STD
            ...
            #else
                #define _MSL_CMAP_ACCESS                                                       \
                    _MSL_LOCALDATA (_current_locale).ctype_cmpt_ptr->ctype_map_ptr
                #define _MSL_CLOWER_ACCESS                                                     \
                    _MSL_LOCALDATA (_current_locale).ctype_cmpt_ptr->lower_map_ptr
                #define _MSL_CUPPER_ACCESS                                                     \
                    _MSL_LOCALDATA (_current_locale).ctype_cmpt_ptr->upper_map_ptr
            #endif /* _MSL_C_LOCALE_ONLY */
