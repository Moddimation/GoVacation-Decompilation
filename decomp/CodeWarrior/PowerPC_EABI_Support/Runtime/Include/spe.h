 ...
 *
 *		Copyright ｩ 2002 Metrowerks, Inc.
 *		All rights reserved.
 */
...
typedef uint32_t __spe_float;
            #define __float_to_spe_float(f)                                                    \
                ({                                                                             \
                    float fmem = (f);                                                          \
                    *(float*)&fmem;                                                            \
                })
            #define __spe_float_to_float(f)                                                    \
                ({                                                                             \
                    __spe_float fmem = (f);                                                    \
                    *(float*)&fmem;                                                            \
                })
    ...
    /*	Several Macro for internal use only	*/
        ...
        #define __ev_gen_std_3op(instr, a, b)                                                  \
            ({                                                                                 \
                register __ev64_opaque__ rR, rA, rB;                                           \
                rA = a;                                                                        \
                rB = b;                                                                        \
                asm {.nonvolatile; instr rR, rA, rB;}                                              \
                rR;                                                                            \
            })
        #define __ev_gen_std_3op_ui32(instr, a, b)                                             \
            ({                                                                                 \
                register uint32_t rR, rA, rB;                                                  \
                rA = a;                                                                        \
                rB = b;                                                                        \
                asm {.nonvolatile; instr rR, rA, rB;}                                              \
                rR;                                                                            \
            })
        #define __ev_gen_std_3op_imm(instr, a, imm)                                            \
            ({                                                                                 \
                register __ev64_opaque__ rD, rA;                                               \
                rA = a;                                                                        \
                asm {.nonvolatile; instr rD,rA,imm}                                              \
                ;                                                                              \
                rD;                                                                            \
            })
        #define __ev_gen_std_3op_from_imm(instr, a, imm)                                       \
            ({                                                                                 \
                register __ev64_opaque__ rD, rA;                                               \
                rA = a;                                                                        \
                asm {.nonvolatile; instr rD,imm,rA}                                              \
                ;                                                                              \
                rD;                                                                            \
            })
        #define __ev_gen_std_2op(instr, a)                                                     \
            ({                                                                                 \
                register __ev64_opaque__ rR, rA;                                               \
                rA = a;                                                                        \
                asm {.nonvolatile; instr rR, rA;}                                                 \
                rR;                                                                            \
            })
        #define __ev_gen_std_2op_imm(instr, imm)                                               \
            ({                                                                                 \
                register __ev64_opaque__ rR;                                                   \
                asm {.nonvolatile; instr rR, imm;}                                                \
                rR;                                                                            \
            })

        #define __ev_op(prefix, cmp, cond, a, b, bit)                                          \
            ({                                                                                 \
                register uint32_t        r;                                                    \
                register __ev64_opaque__ rA, rB;                                               \
                rA = a;                                                                        \
                rB = b;                                                                        \
                asm {.nonvolatile; prefix##cmp##cond cr0, rA, rB;mfcr r;}                           \
                (_Bool) ((r >> bit) & 1);                                                      \
            })
        ...
        #define __ev_select_cmp_cond(prefix, cond, a, b, c, d)                                 \
            ({                                                                                 \
                register __ev64_opaque__ rR, rA, rB, rC, rD;                                   \
                rA = a;                                                                        \
                rB = b;                                                                        \
                rC = c;                                                                        \
                rD = d;                                                                        \
                asm {.nonvolatile; prefix##cmp##cond cr0, rA, rB; evsel rR, rC, rD, cr0}                \
                rR;                                                                            \
            })
        ...
        #define __ev_select_tst_cond(prefix, cond, a, b, c, d)                                 \
            ({                                                                                 \
                ...
                rC = c;                                                                        \
                rD = d;                                                                        \
                asm {.nonvolatile; prefix##tst##cond cr0, rA, rB; evsel rR, rC, rD, cr0}                \
                rR;                                                                            \
            })

        #define __ev_load_t(instr, b, i, t)                                                    \
            ({                                                                                 \
                register __ev64_opaque__ rR;                                                   \
                ...
                rB = b;                                                                        \
                rI = i;                                                                        \
                asm {.nonvolatile; instr rR, rB, rI;}                                              \
                rR;                                                                            \
            })
        #define __ev_load_displ_t(instr, b, displ, t)                                          \
            ({                                                                                 \
                register __ev64_opaque__ rR;                                                   \
                register t*              rB;                                                   \
                rB = b;                                                                        \
                asm {.nonvolatile; instr rR, (displ)(rB);}                                        \
                rR;                                                                            \
            })
        #define __ev_store_t(instr, d, b, i, t)                                                \
            do {                                                                               \
                register __ev64_opaque__ rD;                                                   \
                register t*              rB;                                                   \
                register int             rI;                                                   \
                rD = d;                                                                        \
                rB = b;                                                                        \
                rI = i;                                                                        \
                asm {.nonvolatile; instr rD, rB, rI;}                                              \
            }                                                                                  \
            while (0)
        #define __ev_store_displ_t(instr, d, b, displ, t)                                      \
            do {                                                                               \
                register __ev64_opaque__ rD;                                                   \
                register t*              rB;                                                   \
                rD = d;                                                                        \
                rB = b;                                                                        \
                asm {.nonvolatile; instr rD, (displ)(rB);}                                        \
            }                                                                                  \
            while (0)
        ...
        #define __ev_load_displ(instr, b, displ)                                               \
            __ev_load_displ_t (instr, b, displ, __ev64_opaque__)
        #define __ev_load_displ_16(instr, b, displ)                                            \
            __ev_load_displ_t (instr, b, displ, uint16_t)
        #define __ev_load_displ_32(instr, b, displ)                                            \
            __ev_load_displ_t (instr, b, displ, uint32_t)
        ...
        #define __ev_store_displ(instr, d, b, displ)                                           \
            __ev_store_displ_t (instr, d, b, displ, __ev64_opaque__)
        #define __ev_store_displ_32(instr, d, b, displ)                                        \
            __ev_store_displ_t (instr, d, b, displ, uint32_t)

        #define __define_ev_load(func, instr)                                                  \
            inline __ev64_opaque__ func (register __ev64_opaque__* ptr,                        \
        ...
        #define __define_ev_store(func, instr)                                                 \
            inline void func (register __ev64_opaque__  v,                                     \
                              register __ev64_opaque__* p,                                     \
                              register int32_t          offset)                                \
            {                                                                                  \
    ...
    */
    ...
    /*	Creation, Insertion, Extraction	*/
        ...
        #define __ev_create_u64(i)                                                             \
            ({                                                                                 \
                register __ev64_opaque__ r;                                                    \
                register uint64_t        rLL = i;                                              \
                asm {.nonvolatile; evmergelo r, rLL@hiword, rLL@loword;}                           \
                r;                                                                             \
            })
        #define __ev_create_s64(i)                                                             \
            ({                                                                                 \
                register __ev64_opaque__ r;                                                    \
                register int64_t         rLL = i;                                              \
                asm {.nonvolatile; evmergelo r, rLL@hiword, rLL@loword;}                           \
                r;                                                                             \
            })

        #define __ev_create_fs(a, b)                                                           \
            ({                                                                                 \
                register __ev64_opaque__ r;                                                    \
                register __spe_float     rA, rB;                                               \
                rA = __float_to_spe_float (a);                                                 \
                rB = __float_to_spe_float (b);                                                 \
                asm {.nonvolatile; evmergelo r, rA, rB}                                            \
                r;                                                                             \
            })
        #define __ev_create_sfix32_fs(a, b)                                                    \
            ({                                                                                 \
                register __ev64_opaque__ r, rfs;                                               \
                register __spe_float     rA, rB;                                               \
                rA = __float_to_spe_float (a);                                                 \
                rB = __float_to_spe_float (b);                                                 \
                asm {.nonvolatile; evmergelo rfs, rA, rB; evfsctsf r, rfs}                            \
                r;                                                                             \
            })
        #define __ev_create_ufix32_fs(a, b)                                                    \
            ({                                                                                 \
                register __ev64_opaque__ r, rfs;                                               \
                register __spe_float     rA, rB;                                               \
                rA = __float_to_spe_float (a);                                                 \
                rB = __float_to_spe_float (b);                                                 \
                asm {.nonvolatile; evmergelo rfs, rA, rB; evfsctuf r, rfs}                            \
                r;                                                                             \
            })

/*
#define __ev_create_u32(a, b)			({register __ev64_opaque__ r; register uint32_t rA =
(a), rB = (b); asm {.nonvolatile; evmergelo r, rA, rB} r;}) #define __ev_create_s32(a, b)
({register __ev64_opaque__ r; register int32_t rA = (a), rB = (b); asm {.nonvolatile; evmergelo
r, rA, rB} r;}) #define __ev_create_u16(a, b, c, d)		__ev_create_u32((((a)<<16) |
((b)&0x0000ffff)),  (((c)<<16) | ((d)&0x0000ffff))) #define __ev_create_s16(a, b, c, d)
__ev_create_s32((((a)<<16) | ((b)&0x0000ffff)),  (((c)<<16) | ((d)&0x0000ffff)))
*/
inline __ev64_opaque__
__ev_create_u32 (register uint32_t rA, register uint32_t rB)
{
    register __ev64_opaque__ r;
    asm {.nonvolatile; evmergelo r, rA, rB}
    return r;
...
inline __ev64_opaque__
__ev_create_s32 (register int32_t rA, register int32_t rB)
{
    register __ev64_opaque__ r;
    asm {.nonvolatile; evmergelo r, rA, rB}
    return r;
...
inline __ev64_opaque__
__ev_create_u16 (register uint16_t a,
                 register uint16_t b,
                 register uint16_t c,
                 register uint16_t d)
{
    return __ev_create_u32 ((((a) << 16) | ((b) & 0x0000ffff)),
                            (((c) << 16) | ((d) & 0x0000ffff)));
}

inline __ev64_opaque__
__ev_create_s16 (register int16_t a, register int16_t b, register int16_t c, register int16_t d)
{
    return __ev_create_s32 ((((a) << 16) | ((b) & 0x0000ffff)),
                            (((c) << 16) | ((d) & 0x0000ffff)));
}
...
inline uint64_t
__ev_convert_u64 (register __ev64_opaque__ a)
{
    register uint64_t        r;
...
inline int64_t
__ev_convert_s64 (register __ev64_opaque__ a)
{
    register int64_t         r;
    register __ev64_opaque__ rtemp;
    asm {.nonvolatile; mr r@loword, a;}
    ...
    /* Internal Use Macros	*/
        ...
        #define __ev_get_upper(type, a)                                                        \
            ({                                                                                 \
                register type            r;                                                    \
                register __ev64_opaque__ rA = a, rtemp;                                        \
                asm {.nonvolatile; evmergehi rtemp, rA, rA;mr r, rtemp;}                             \
                r;                                                                             \
            })
        #define __ev_get_lower(type, a)                                                        \
            ({                                                                                 \
                register type            r;                                                    \
                register __ev64_opaque__ rA = a;                                               \
                asm {.nonvolatile; mr r, rA;}                                                     \
                r;                                                                             \
            })
        #define __ev_get_upper_fs(a)                                                           \
            ({                                                                                 \
                register __spe_float     r;                                                    \
                register __ev64_opaque__ rA = a, rtemp;                                        \
                asm {.nonvolatile; evmergehi rtemp, rA, rA;mr r, rtemp;}                             \
                __spe_float_to_float (r);                                                      \
            })
        #define __ev_get_lower_fs(a)                                                           \
            ({                                                                                 \
                register __spe_float     r;                                                    \
                register __ev64_opaque__ rA = a;                                               \
                asm {.nonvolatile; mr r, rA;}                                                     \
        ...
        #define __ev_set_upper(type, a, upper)                                                 \
            ({                                                                                 \
                register __ev64_opaque__ r, rA = a;                                            \
                register type            rU = upper;                                           \
                asm {.nonvolatile; evmergelo r, rU, rA;}                                           \
                r;                                                                             \
            })
        #define __ev_set_lower(type, a, lower)                                                 \
            ({                                                                                 \
                register __ev64_opaque__ r, rA = a;                                            \
                register type            rL = lower;                                           \
                asm {.nonvolatile; evmergehilo r, rA, rL;}                                         \
                r;                                                                             \
            })
        #define __ev_set_upper_fs(a, upper)                                                    \
            ({                                                                                 \
                register __ev64_opaque__ r, rA = a;                                            \
                register __spe_float     rU = __float_to_spe_float (upper);                    \
                asm {.nonvolatile; evmergelo r, rU, rA;}                                           \
                r;                                                                             \
            })
        #define __ev_set_lower_fs(a, lower)                                                    \
            ({                                                                                 \
                register __ev64_opaque__ r, rA = a;                                            \
                register __spe_float     rL = __float_to_spe_float (lower);                    \
                asm {.nonvolatile; evmergehilo r, rA, rL;}                                         \
                r;                                                                             \
            })
...
inline __ev64_opaque__
__ev_set_upper_sfix32_fs (register __ev64_opaque__ a, register float b)
{
...
inline __ev64_opaque__
__ev_set_lower_sfix32_fs (register __ev64_opaque__ a, register float b)
{
    register int32_t     temp;
    register __spe_float f;
    f = __float_to_spe_float (b);
...
inline __ev64_opaque__
__ev_set_upper_ufix32_fs (register __ev64_opaque__ a, register float b)
{
    register int32_t     temp;
    register __spe_float f;
    f = __float_to_spe_float (b);
...
inline __ev64_opaque__
__ev_set_lower_ufix32_fs (register __ev64_opaque__ a, register float b)
{
    register int32_t     temp;
    register __spe_float f;
    f = __float_to_spe_float (b);
...
inline __ev64_opaque__
__ev_set_acc_u64 (register uint64_t a)
{
    return __ev_set_acc_vec64 (__ev_create_u64 (a));
}

inline __ev64_opaque__
__ev_set_acc_s64 (register int64_t a)
{
    return __ev_set_acc_vec64 (__ev_create_s64 (a));
}

inline __ev64_opaque__
__ev_set_u32 (register __ev64_opaque__ a, register uint32_t b, register uint32_t pos)
{
    return (pos & 1) ? __ev_set_lower_u32 (a, b) : __ev_set_upper_u32 (a, b);
}

inline __ev64_opaque__
__ev_set_s32 (register __ev64_opaque__ a, register int32_t b, register uint32_t pos)
{
    return (pos & 1) ? __ev_set_lower_s32 (a, b) : __ev_set_upper_s32 (a, b);
}

inline __ev64_opaque__
__ev_set_fs (register __ev64_opaque__ a, register float b, register uint32_t pos)
{
    return (pos & 1) ? __ev_set_lower_fs (a, b) : __ev_set_upper_fs (a, b);
}

inline __ev64_opaque__
__ev_set_u16 (register __ev64_opaque__ a, register uint16_t b, register uint32_t pos)
{
        #if 1
    __ev64_u16__ t = a;
...
inline __ev64_opaque__
__ev_set_s16 (register __ev64_opaque__ a, register int16_t b, register uint32_t pos)
{
        #if 1
    __ev64_s16__ t = a;
    int16_t*     p = (int16_t*)&t;
...
inline __ev64_opaque__
__ev_set_ufix32_u32 (register __ev64_opaque__ a, register uint32_t b, register uint32_t pos)
{
    __ev64_s16__ t = a;
...
inline __ev64_opaque__
__ev_set_sfix32_s32 (register __ev64_opaque__ a, register int32_t b, register uint32_t pos)
{
    __ev64_s16__ t = a;
    int32_t*     p = (int32_t*)&t;
    p[pos & 3]     = b;
...
inline __ev64_opaque__
__ev_set_ufix32_fs (register __ev64_opaque__ a, register float b, register uint32_t pos)
{
    return (pos & 1) ? __ev_set_lower_ufix32_fs (a, b) : __ev_set_upper_ufix32_fs (a, b);
}

inline __ev64_opaque__
__ev_set_sfix32_fs (register __ev64_opaque__ a, register float b, register uint32_t pos)
{
    return (pos & 1) ? __ev_set_lower_sfix32_fs (a, b) : __ev_set_upper_sfix32_fs (a, b);
}

inline uint32_t
__ev_get_u32 (register __ev64_opaque__ a, register uint32_t pos)
{
    return (pos & 1) ? __ev_get_lower_u32 (a) : __ev_get_upper_u32 (a);
}

inline int32_t
__ev_get_s32 (register __ev64_opaque__ a, register uint32_t pos)
{
    return (pos & 1) ? __ev_get_lower_s32 (a) : __ev_get_upper_s32 (a);
}

inline float
__ev_get_fs (register __ev64_opaque__ a, register uint32_t pos)
{
    return (pos & 1) ? __ev_get_lower_fs (a) : __ev_get_upper_fs (a);
}

inline uint16_t
__ev_get_u16 (register __ev64_opaque__ a, register uint32_t pos)
{
...
inline int16_t
__ev_get_s16 (register __ev64_opaque__ a, register uint32_t pos)
{
...
inline uint32_t
__ev_get_ufix32_u32 (register __ev64_opaque__ a, register uint32_t pos)
{
    return (pos & 1) ? __ev_get_lower_ufix32_u32 (a) : __ev_get_upper_ufix32_u32 (a);
}

inline int32_t
__ev_get_sfix32_s32 (register __ev64_opaque__ a, register uint32_t pos)
{
    return (pos & 1) ? __ev_get_lower_sfix32_s32 (a) : __ev_get_upper_sfix32_s32 (a);
}

inline float
__ev_get_ufix32_fs (register __ev64_opaque__ a, register uint32_t pos)
{
    return (pos & 1) ? __ev_get_lower_ufix32_fs (a) : __ev_get_upper_ufix32_fs (a);
}

inline float
__ev_get_sfix32_fs (register __ev64_opaque__ a, register uint32_t pos)
{
    ...
    /*	SPEFSCR Low Level Accessors	*/
        ...
        #define __ev_getnclr_spefscr(field)                                                    \
            ({                                                                                 \
                register uint32_t r, rd;                                                       \
                asm {.nonvolatile; mfspr r,spefscr;}                                             \
                rd = r & ‾__ev_bit_from_64 (field);                                            \
                asm {.nonvolatile; mtspr spefscr, rd;}                                            \
                (r >> (63 - field)) & 1;                                                       \
            })
        ...
        /*	CLR & SET functions	*/
        #define __ev_clr_spefscr_field(field)                                                  \
            do {                                                                               \
                register uint32_t r;                                                           \
                asm {.nonvolatile; mfspr r,spefscr;}                                             \
                r &= ‾__ev_bit_from_64 (field);                                                \
...
inline void
__ev_set_spefscr_frmc (register uint32_t rnd)
{
    register uint32_t r;
    asm {.nonvolatile; mfspr r,spefscr;}
    r = (r & ‾0x3) | (rnd & 0x3);
...
int16_t _MSL_CDECL  strtosfix16 (const char* str, char** endptr);
int32_t _MSL_CDECL  strtosfix32 (const char* str, char** endptr);
int64_t _MSL_CDECL  strtosfix64 (const char* str, char** endptr);
uint16_t _MSL_CDECL strtoufix16 (const char* str, char** endptr);
uint32_t _MSL_CDECL strtoufix32 (const char* str, char** endptr);
uint64_t _MSL_CDECL strtoufix64 (const char* str, char** endptr);
int16_t _MSL_CDECL  atosfix16 (const char* str);
int32_t _MSL_CDECL  atosfix32 (const char* str);
int64_t _MSL_CDECL  atosfix64 (const char* str);
uint16_t _MSL_CDECL atoufix16 (const char* str);
uint32_t _MSL_CDECL atoufix32 (const char* str);
uint64_t _MSL_CDECL atoufix64 (const char* str);
