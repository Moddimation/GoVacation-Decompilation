...
_MSL_IMP_EXP_C void* _MSL_CDECL __pool_alloc (__mem_pool* pool_obj,
                                              __std (size_t) size) _MSL_CANT_THROW;
_MSL_IMP_EXP_C void _MSL_CDECL  __pool_free (__mem_pool* pool_obj, void* ptr) _MSL_CANT_THROW;
_MSL_IMP_EXP_C void* _MSL_CDECL __pool_realloc (__mem_pool* pool_obj,
                                                void*       ptr,
                                                __std (size_t) size) _MSL_CANT_THROW;
_MSL_IMP_EXP_C void* _MSL_CDECL __pool_alloc_clear (__mem_pool* pool_obj,
                                                    __std (size_t) size) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C int _MSL_CDECL init_alloc (void*,
                                          __std (size_t)
                                              heap_size) _MSL_CANT_THROW; /*- hh 990504 -*/
...
int _MSL_CDECL   __pool_preallocate (mem_pool_obj* pool_obj,
                                     mem_size) _MSL_CANT_THROW;               /*- mf 990715 -*/
void _MSL_CDECL  __pool_preassign (mem_pool_obj* pool_obj,
                                   void*,
                                   mem_size) _MSL_CANT_THROW;                 /*- mf 990715 -*/
void* _MSL_CDECL __pool_alloc (mem_pool_obj* pool_obj,
                               mem_size) _MSL_CANT_THROW;                     /*- mf 990715 -*/
void* _MSL_CDECL __pool_alloc_clear (mem_pool_obj* pool_obj,
                                     mem_size) _MSL_CANT_THROW;               /*- mf 990715 -*/
void* _MSL_CDECL __pool_realloc (mem_pool_obj* pool_obj,
                                 void*,
                                 mem_size) _MSL_CANT_THROW;                   /*- mf 990715 -*/
