...
#endif
        lwz                      r5,
        PTMF.this_delta (r3) lwz r6, PTMF.vtbl_offset (r3) lwz r7, PTMF.func_data (r3) li r3,
        1 cmpwi cr0, r5, 0 cmpwi cr6, r6, 0 cmpwi cr7, r7,
...
__ptmf_cmpr (register PTMF* ptmf1, register PTMF* ptmf2)
{
    ...
    smclass GL
        ...
        PTMF.vtbl_offset (r4) lwz r9, PTMF.func_data (r3) lwz r10, PTMF.func_data (r4) li r3,
        1 cmpw cr0, r5, r6 cmpw cr6, r7, r8 cmpw cr7, r9,
        r10 bnelr cr0 bnelr cr6 bnelr cr7 li r3, 0 blr
}
