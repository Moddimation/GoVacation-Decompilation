...
int _MSL_CDECL
_creat (const char* path, mode_t mode) _MSL_CANT_THROW
{
    return creat (path, mode);
}

int _MSL_CDECL
_fcntl (int fildes, int cmd, ...) _MSL_CANT_THROW
{
    return fcntl (fildes, cmd);
}

int _MSL_CDECL
_open (const char* path, int oflag, ...) _MSL_CANT_THROW
{
...
int _MSL_CDECL
_fstat (int fildes, struct _MSL_STAT_TYPE* buf) _MSL_CANT_THROW
{
    return fstat (fildes, (struct stat*)buf);
}

int _MSL_CDECL
_mkdir (const char* path, ...) _MSL_CANT_THROW
{
    return mkdir (path);
}

int _MSL_CDECL
_stat (const char* path, struct _MSL_STAT_TYPE* buf) _MSL_CANT_THROW
{
...
int _MSL_CDECL
_fileno (FILE* stream) _MSL_CANT_THROW
{
    return fileno (stream);
}

FILE* _MSL_CDECL
_fdopen (int fildes, const char* type) _MSL_CANT_THROW
{
...
_MSL_IMP_EXP_C int _MSL_CDECL _execve (const char*,
                                       const char* const *,
                                       const char* const *) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C int _MSL_CDECL _execvpe (const char*,
                                        const char* const *,
                                        const char* const *) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C int _MSL_CDECL _spawnve (int,
                                        const char*,
                                        const char* const *,
                                        const char* const *) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C int _MSL_CDECL _spawnvpe (int,
                                         const char*,
                                         const char* const *,
                                         const char* const *) _MSL_CANT_THROW;
...
int _MSL_CDECL
_access (const char* path, int mode) _MSL_CANT_THROW
{
    return access (path, mode);
}

int _MSL_CDECL
_chdir (const char* path) _MSL_CANT_THROW
{
    return chdir (path);
}

int _MSL_CDECL
_close (int fildes) _MSL_CANT_THROW
{
    return close (fildes);
}

char* _MSL_CDECL
_cuserid (char* string) _MSL_CANT_THROW
{
    return cuserid (string);
}

int _MSL_CDECL
_exec (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}
...
int _MSL_CDECL
_spawnl (int mode, const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_spawnle (int mode, const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_spawnlp (int mode, const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_spawnlpe (int mode, const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_execl (const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_execle (const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_execlp (const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_execlpe (const char* prog, ...) _MSL_CANT_THROW
{
    va_list va;
    int     ret;
...
int _MSL_CDECL
_execv (const char* prog, const char* const * args) _MSL_CANT_THROW
{
    return execv (prog, args);
}

int _MSL_CDECL
_execve (const char* prog, const char* const * args, const char* const * envp) _MSL_CANT_THROW
{
    return execve (prog, args, envp);
}

int _MSL_CDECL
_execvp (const char* prog, const char* const * args) _MSL_CANT_THROW
{
    return execvp (prog, args);
}

int _MSL_CDECL
_execvpe (const char* prog, const char* const * args, const char* const * envp) _MSL_CANT_THROW
{
    return execvpe (prog, args, envp);
}

int _MSL_CDECL
_spawnv (int mode, const char* prog, const char* const * args) _MSL_CANT_THROW
{
    return spawnv (mode, prog, args);
}

int _MSL_CDECL
_spawnve (int mode, const char* prog, const char* const * args, const char* const * envp)
    _MSL_CANT_THROW
{
...
int _MSL_CDECL
_spawnvp (int mode, const char* prog, const char* const * args) _MSL_CANT_THROW
{
    return spawnvp (mode, prog, args);
}

int _MSL_CDECL
_spawnvpe (int mode, const char* prog, const char* const * args, const char* const * envp)
    _MSL_CANT_THROW
{
...
int _MSL_CDECL
_cwait (int* termstat, int pid, int action) _MSL_CANT_THROW
{
    return cwait (termstat, pid, action);
}

int _MSL_CDECL
_dup (int _a) _MSL_CANT_THROW
{
    return dup (_a);
}

int _MSL_CDECL
_dup2 (int _a, int _b) _MSL_CANT_THROW
{
    return dup2 (_a, _b);
}
...
int _MSL_CDECL
_execl (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}

int _MSL_CDECL
_execle (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}

int _MSL_CDECL
_execlp (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}

int _MSL_CDECL
_execv (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}

int _MSL_CDECL
_execve (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}

int _MSL_CDECL
_execvp (const char* path, ...) _MSL_CANT_THROW
{
    return exec (path);
}
...
char* _MSL_CDECL
_getcwd (char* buf, int size) _MSL_CANT_THROW
{
    return getcwd (buf, size);
}

char* _MSL_CDECL
_getlogin (void) _MSL_CANT_THROW
{
    return getlogin();
}

int _MSL_CDECL
_getpid (void) _MSL_CANT_THROW
{
    return getpid();
}

int _MSL_CDECL
_isatty (int fildes) _MSL_CANT_THROW
{
    return isatty (fildes);
}

long _MSL_CDECL
_lseek (int fildes, long offset, int whence) _MSL_CANT_THROW
{
    return lseek (fildes, offset, whence);
}

int _MSL_CDECL
_read (int fildes, void* buf, size_t count) _MSL_CANT_THROW
{
    return read (fildes, buf, count);
}

int _MSL_CDECL
_rmdir (const char* path) _MSL_CANT_THROW
{
    return rmdir (path);
}

unsigned int _MSL_CDECL
_sleep (unsigned int seconds) _MSL_CANT_THROW
{
    return sleep (seconds);
}

char* _MSL_CDECL
_ttyname (int fildes) _MSL_CANT_THROW
{
    return ttyname (fildes);
}

int _MSL_CDECL
_unlink (const char* path) _MSL_CANT_THROW
{
    return unlink (path);
}

int _MSL_CDECL
_write (int fildes, const void* buf, size_t count) _MSL_CANT_THROW
{
...
_MSL_IMP_EXP_C _MSL_POSIX_PARAMS _MSL_CDECL _umask (_MSL_POSIX_PARAMS)
    _MSL_CANT_THROW; /*- cc 000210 -*/

int _MSL_CDECL
_chmod (const char* path, mode_t mode) _MSL_CANT_THROW
{
    return chmod (path, mode);
}

_MSL_POSIX_PARAMS _MSL_CDECL
_umask (_MSL_POSIX_PARAMS __pmode) _MSL_CANT_THROW
{
...
_MSL_IMP_EXP_C int _MSL_CDECL _utime (const char*,
                                      _MSL_STRUCT_UTIMEBUF_TYPE utimbuf*) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_CDECL _utimes (const char* path, struct timeval buf[2]) _MSL_CANT_THROW;

int _MSL_CDECL
_utime (const char* path, _MSL_STRUCT_UTIMEBUF_TYPE utimbuf* buf) _MSL_CANT_THROW
{
    return utime (path, buf);
}

int _MSL_CDECL
_utimes (const char* path, struct timeval buf[2]) _MSL_CANT_THROW
{
...
int _MSL_CDECL
_uname (struct utsname* name) _MSL_CANT_THROW
{
    return uname (name);
}
