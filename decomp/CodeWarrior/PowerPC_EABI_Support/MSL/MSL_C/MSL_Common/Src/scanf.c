...
/* dsp56800 uses 16-bit pointers*/
        ...
        case '[':
            ...
            if (invert)
            {
                ...
                for (i = sizeof (f.char_set), p = f.char_set; i; --i, ++p) *p = ‾* p;
            }
...
static int
__sformatter (int (_MSL_CDECL* ReadProc) (void*, int, int),
              void*       ReadProcArg,
              ...
              int         is_secure)                         /*- mm 990325 -*/
{
    ...
    while (!terminate && (format_char = *format_ptr) != 0) /*- mm 990311 -*/   /*- mm 990608 -*/
    {
        ...
        if ((format.conversion_char != 'n') && (!match_failure) &&
            (*ReadProc) (ReadProcArg, 0, __TestForError)) /*- mm 990608 -*/
        {                                                 /*- mm 990608 -*/
            if (!is_secure)
                goto exit;                                /*- mm 990608 -*/
            else
                ...
                if (arg_ptr)
                {
                    ...
                    else
                    {
                        ...
                        while (
                            ...
                            ((rval = ((*ReadProc) (ReadProcArg, 0, __GetAChar))) !=
                             EOF)) /*- mm 990325 -*/ /*- mm 010426 -*/     /*- mm 011207 -*/
                        {
                            c = rval;                                      /*- mm 010426 -*/
#if _MSL_WIDE_CHAR
...
int _MSL_CDECL
fscanf (FILE* _MSL_RESTRICT file, const char* _MSL_RESTRICT format, ...)
{
    ...
    if (fwide (file, -1) >= 0) /*- mm 990618 -*/              /*- mm 000404 -*/
        ...
        #endif /* _MSL_WIDE_CHAR && _MSL_C99 */ /*- mm 980205 -*/      /*- mm 030314 -*/
    __begin_critical_region (crtrgn); /*- mm 001013 -*/       /*- mm 020627 -*/
    retval = __sformatter (&__FileRead,
                           (void*)file,
                           format,
                           __va_start (format),
                           0);                                /*- mm 001013 -*/
...
int _MSL_CDECL
fscanf_s (FILE* _MSL_RESTRICT file, const char* _MSL_RESTRICT format, ...)
{
    int retval;                                                        /*- mm 001013 -*/
    int crtrgn;
    #if (defined(__PPC_EABI__) || defined(__MIPS__))
...
/*- mm 000831 -*/
int _MSL_CDECL
vscanf (const char* _MSL_RESTRICT format, va_list arg)
{
    int retval;                                                        /*- mm 001013 -*/
...
int _MSL_CDECL
scanf (const char* _MSL_RESTRICT format, ...)
{
    int retval;                                                         /*- mm 001013 -*/
    #if (defined(__PPC_EABI__) || defined(__MIPS__))
    va_list args;
...
int _MSL_CDECL
scanf_s (const char* _MSL_RESTRICT format, ...)
{
    int retval;                                                         /*- mm 001013 -*/
    #if (defined(__PPC_EABI__) || defined(__MIPS__))
    va_list args;
...
int _MSL_CDECL
vfscanf (FILE* _MSL_RESTRICT       file,
         const char* _MSL_RESTRICT format,
...
int _MSL_CDECL
vfscanf_s (FILE* _MSL_RESTRICT       file,
           const char* _MSL_RESTRICT format,
           va_list                   arg)                                               /*- mm 990828 -*/
{
    int retval;                                                       /*- mm 001013 -*/
...
int _MSL_CDECL
vsscanf (const char* _MSL_RESTRICT s,
         const char* _MSL_RESTRICT format,
         va_list                   arg)                     /*- mm 990828 -*/
{
    __InStrCtrl isc;
...
int _MSL_CDECL
vsscanf_s (const char* _MSL_RESTRICT s,
           const char* _MSL_RESTRICT format,
           va_list                   arg)                   /*- mm 990828 -*/
{
    __InStrCtrl isc;
...
int _MSL_CDECL
sscanf (const char* _MSL_RESTRICT s, const char* _MSL_RESTRICT format, ...)
{
#if (defined(__PPC_EABI__) || defined(__MIPS__))
    va_list args;
...
int _MSL_CDECL
sscanf_s (const char* _MSL_RESTRICT s, const char* _MSL_RESTRICT format, ...)
{
#if (defined(__PPC_EABI__) || defined(__MIPS__))
    va_list args;
    ...
    return (vsscanf_s (s, format, __va_start (format)));                       /*- mm 990828 -*/
                                           ...
                                           * mm  980331 Modification to allow characters >= 128, e.g. ｧ or ﾉ to be matched from format
                                           ...
                                           * mm  990413 Corrected handling of case where source text quits early IL9904-0736
                                           * mm  990527 Corrected of string read function in case of unget and made %n work after end of
                                           *file                                           mm  990617 Correction for case where pointer to source string for sscanf == NULL or
                                           *source string is null                                           mm  990716 Correction to code for checking format.char_set                                           mm  990817
                                           *Deleted include of <string_io.h>                                           mm  990828 Restored vfscanf and vsscanf since they are
                                           *defined in C9x                                           vss 990909 Fixed Altivec bug with va_args not being assigned on time                                           mm  000404
                                           *Corrected detection of null input file                                           mm  000831 Added vscanf since it is defined in C99
                                           *WB1-16280                                           mm  001013 Added threadsafety                                           mm  010426 Correction to detect difference between
                                           *character 0xff and eof.                                           mm  010818 Correction to make sure that if no characters are ignored,
                                           *scanf doesn't abort.  WB1-26254                                           cc  011203 Added _MSL_CDECL for new name mangling                                           mm  011207
                                           *Changes to detect characters of value 0xff as distinct from EOF                                           mm  020103 Corrected mm 011207
                                           *changes                                           cc  020109 More _MSL_CDECL                                           mm  020529 Support for C99 length modifiers j, z, and t.                                           mm
                                           *020627 Changes to prevent io on stdin, stdout, stderr and general files from interfering with
                                           *each other                                           JWW 020917 Added _MSL_RESTRICT to get the restrict type specifier for certain C99
                                           *functions                                           mm  021217 Changes to bring scanf up to C99                                           JWW 030224 Changed
                                           *__MSL_LONGLONG_SUPPORT__ flag into the new more configurable _MSL_LONGLONG                                           JWW 030224 Changed
                                           *__NO_WIDE_CHAR flag into the new more configurable _MSL_WIDE_CHAR                                           mm  030304 Added some
                                           *_MSL_C99 wrappers                                           mm  030314 Added some more _MSL_C99 wrappers                                           mm  030317 And some more                                           JWW
                                           *031030 Added the __STDC_WANT_LIB_EXT1__ secure library extensions                                           cc  040217 Changed
                                           *_No_Floating_Point to _MSL_FLOATING_POINT                                           cc  040217 Changed _No_Disk_File_OS_Support to
                                           *_MSL_OS_DISK_FILE_SUPPORT                                           JWW 040317 Updated the __STDC_WANT_LIB_EXT1__ secure library based
                                           *on new secure specifications                                           mm  040429 Changes to avoid nesting of critical regions                                           mm                                           040811
                                           *Changes to handle arguments of type intmax_t                                           cc  041014 Added _Old_DSP_IO_Interface checks                                           mm
                                           *041029 Changed to handle an empty string under %s and return EOF, not zero.                                           cc  050504 Changed
                                           *back to old way of handling empty string
                                           */
