 ...
 *
 * $Date: 2007/01/29 21:24:43 $
 * $Revision: 1.10.2.1 $
 */

/*
  This single precision version of expf misses at most the last 3 bits when compared with
  the built in Intel algorithm.  The result is exactly the correctly rounded result produced
  from the Intel library over 67% of the time.  The accuracy can be further improved by writing
  the constants in two_to_frac as a vector and scaling the arithmetic in the reassembly step.
*/
