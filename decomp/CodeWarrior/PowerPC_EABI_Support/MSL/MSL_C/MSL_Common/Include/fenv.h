 ...
 *      "fenv_access" pragma.                                                   *
 *                                                                              * * Written by
 *Ali Sazegari, started on October 1992.                       *
 ********************************************************************************/
...
typedef long int fexcept_t;
                    /* FP EXCEPTION FLAGS */
                    #define FE_DIVBYZERO                                                       \
                        0x04000000 /* bit 5 from left of the FPSCR, !!don't forget 2 count bit \
                                      0!! */
...
typedef struct
{
    ...
    __ieee_handler_t inexact_handler;
                    ...
                    /* ROUNDING MODES */
                    #define FE_TONEAREST                                                       \
                        ((unsigned long)0x00000000)               /* FPSCR bits[23:22] = 0b00 */
                    #define FE_TOWARDZERO                                                      \
                        ((unsigned long)0x00C00000)               /* FPSCR bits[23:22] = 0b11 */
                    #define FE_UPWARD ((unsigned long)0x00400000) /* FPSCR bits[23:22] = 0b01  \
                                                                   */
                    #define FE_DOWNWARD                                                        \
                        ((unsigned long)0x00800000)               /* FPSCR bits[23:22] = 0b10 */
                #endif                                            /* __arm */
...
_MSL_END_EXTERN_C
                    ...
                    #include <fenv.ARM.h>
                                                 ...
                                                 * JPO 930205 Changed function types of feclearexcept,fegetexcept, feraiseexcept, and
                                                 * fesetexcept                                                 from int to void to reflect changes in NCEG specification.  Changed definition of
                                                 ...
                                                 * JWW 020724 Don't use external fenv.h file when compiling for Mach-O since this one will
                                                 * suffice                                                 ss  030203 Added arm specific defines                                                 mm  030226 Added _MSL_C99 wrapper since fenv.h
                                                 * does not occur in C90                                                 bn  030425 Added ARM specific user-defined exception handlers
                                                 */
