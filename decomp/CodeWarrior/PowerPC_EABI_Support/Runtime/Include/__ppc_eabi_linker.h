...
after last byte in section begin with '_e' and rom addresses end in a '_rom'.  The linker
command file allows you to define your own symbols and it allows you to create an alias to the
...
__declspec (section
            ".init") extern char _SDA_BASE_[];  /* Small Data Area (<=8 bytes) base addr */
                                                /* used for .sdata, .sbss */
__declspec (section
...
typedef struct __pic_rom_copy_info
{
    ...
    unsigned char*
        ram_end; /* end address in ram (executing address);  pre-eppc 7.0, this was the size */
} __pic_rom_copy_info;

__declspec (section ".init") extern __pic_rom_copy_info
    _pic_rom_copy_info[]; /* An array of all initialized (data, text or mixed) sections */
...
__declspec (section ".init") extern __pic_bss_init_info
...
typedef struct __pic_eti_init_info
{
    ...
    unsigned char*
        code_end; /* address of end of this code segment; pre-eppc 7.0, this was the size */
} __pic_eti_init_info;

__declspec (section ".init") extern __pic_eti_init_info
...
__declspec (section
            ".init") extern char _e_init[]; /* .init dest. (RAM) address after end byte */
...
__declspec (section
            ".init") extern char _e_text[]; /* .text dest. (RAM) address after end byte */
...
__declspec (section
            ".init") extern char _f_rodata[]; /* .rodata dest. (RAM) address at beginning */
__declspec (section
...
__declspec (section
            ".init") extern char _eextab[]; /* extab dest. (RAM) address after end byte */
...
__declspec (section
            ".init") extern char _e_data[]; /* .data dest. (RAM) address after end byte */
...
__declspec (section
            ".init") extern char _f_sdata[];     /* .sdata dest. (RAM) address at beginning */
__declspec (section
            ".init") extern char _e_sdata[];     /* .sdata dest. (RAM) address after end byte */
...
__declspec (section
            ".init") extern char _e_sbss[]; /* .sbss dest. (RAM) address after end byte */
...
__declspec (section
            ".init") extern char _f_sdata2[]; /* .sdata2 dest. (RAM) address at beginning */
__declspec (section
...
__declspec (section
            ".init") extern char _f_sbss2[]; /* .sbss2 dest. (RAM) address at beginning */
__declspec (section
            ".init") extern char _e_sbss2[]; /* .sbss2 dest. (RAM) address after end byte */
...
__declspec (section ".init") extern unsigned int
    _f_mwerks_fixup[]; /* .mwerks_fixup dest. (RAM) address at beginning */
__declspec (section ".init") extern unsigned int
    _e_mwerks_fixup[]; /* .mwerks_fixup dest. (RAM) address after end byte */

__declspec (section ".init") extern char
    _ABS_SDA_BASE_[];  /* same as _SDA_BASE_ but is absolute addressed even with SDA PIC/PID */
__declspec (section ".init") extern char
    _ABS_SDA2_BASE_[]; /* same as _SDA2_BASE_ but is absolute addressed even with SDA PIC/PID */
