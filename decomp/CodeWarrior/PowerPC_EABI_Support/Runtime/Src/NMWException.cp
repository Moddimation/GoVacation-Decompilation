        ...
        case '!':
            ...
            {                                //	class name compare loop
                ...
                else
                {
                    ...
                    if (*cptr1 == 0)
                        return false;        //	no more class names => no match
                       ...
                       size_t                n)
{
    ...
    {
        size_t* p  = (size_t*)ptr;
        //	store number of allocated objects and size of one object at the beginnig of the
        //allocated block
        p[0]       = size;
        p[1]       = n;
    ...
    #pragma exception_arrayinit
            ...
            for (i = 0, p = ptr; i < n; i++, p += size) { CTORCALL_COMPLETE (ctor, p); }
        }
    }
                   ...
                   size_t                n)
{
    ...
    for (i = 0, p = (char*)ptr; i < n; i++, p += size) { CTORCALL_COMPLETE (ctor, p); }
}
                      ...
                      short                 has_size_t_param)
{
    ...
    if (block)
    {
        ...
        { //	call deallocation functiuon
            ...
            if (has_size_t_param)
            {
                ((void (*) (void*, size_t))dealloc_func) (p,
