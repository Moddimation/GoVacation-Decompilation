...
const wchar_t __wlower_map[__msl_wcmap_size] =              /*- mm 020219 -*/
    {
        ...
        0x0016, 0x0017, 0x0018, 0x0019, 0x001A, 0x001B, 0x001C, 0x001D, 0x001E, 0x001F, L' ',
        L'!',   L'"',   L'#',   L'$',   L'%',   L'&',   L'\'',  L'(',   L')',   L'*',   L'+',
        L',',   L'-',   L'.',   L'/',   L'0',   L'1',   L'2',   L'3',   L'4',   L'5',   L'6',
        L'7',   L'8',   L'9',   L':',   L';',   L'<',   L'=',   L'>',   L'?',   L'@',   L'a',
        L'b',   L'c',   L'd',   L'e',   L'f',   L'g',   L'h',   L'i',   L'j',   L'k',   L'l',
        L'm',   L'n',   L'o',   L'p',   L'q',   L'r',   L's',   L't',   L'u',   L'v',   L'w',
        L'x',   L'y',   L'z',   L'[',   L'\\',  L']',   L'^',   L'_',   L'`',   L'a',   L'b',
        L'c',   L'd',   L'e',   L'f',   L'g',   L'h',   L'i',   L'j',   L'k',   L'l',   L'm',
        L'n',   L'o',   L'p',   L'q',   L'r',   L's',   L't',   L'u',   L'v',   L'w',   L'x',
        L'y',   L'z',   L'{',   L'|',   L'}',   L'~',   0x007F,
        #if __dest_os == __mac_os || __dest_os == __mac_os_x /*- Begin mm 030107 insertion -*/
        0x008A, 0x008C, 0x008D, 0x008E, 0x0096, 0x009A, 0x009F, 0x0087, 0x0088, 0x0089, 0x008A,
        ...
        0x00AC, 0x00AD, 0x00BE, 0x00BF, 0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x00B5, 0x00B6,
        0x00B7, 0x00B8, 0x00B9, 0x00BA, 0x00BB, 0x00BC, 0x00BD, 0x00BE, 0x00BF, 0x00C0, 0x00C1,
        0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x0088, 0x008B,
        0x009B, 0x00CF, 0x00CF, 0x00D0, 0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00D7,
        0x00D8, 0x00D8, 0x00DA, 0x00DB, 0x00DC, 0x00DD, 0x00DE, 0x00DF, 0x00E0, 0x00E1, 0x00E2,
        0x00E3, 0x00E4, 0x0089, 0x0090, 0x0087, 0x0091, 0x008F, 0x0092, 0x0094, 0x0095, 0x0093,
        0x0097, 0x0099, 0x00F0, 0x0098, 0x009C, 0x009E, 0x009D, 0x00F5, 0x00F6, 0x00F7, 0x00F8,
	...
	L'',  L'ò',  L'ú',  L'û',  L'ù',  L'ı',  L'ˆ',  L'˜',  L'¯',  L'˘',  L'˙',  L'˚',  L'¸',  L'˝',  L'˛',  L'ˇ'	/*- mm 980629 -*/
        ...
        0x00B7, 0x00B8, 0x00B9, 0x00BA, 0x00BB, 0x00BC, 0x00BD, 0x00BE, 0x00BF, 0x00E0, 0x00E1,
        0x00E2, 0x00E3, 0x00E4, 0x00E5, 0x00E6, 0x00E7, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC,
        0x00ED, 0x00EE, 0x00EF, 0x00F0, 0x00F1, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x00F6, 0x00D7,
        0x00F8, 0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x00FD, 0x00DE, 0x00DF, 0x00E0, 0x00E1, 0x00E2,
...
const wchar_t __wupper_map[__msl_wcmap_size] = {
    ...
    L'V',   L'W',   L'X',   L'Y',   L'Z',   L'{',   L'|',   L'}',   L'~',   0x007F,
        #if __dest_os == __mac_os || __dest_os == __mac_os_x /*- Begin mm 030107 insertion -*/
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x00E7, 0x00CB, 0x00E5, 0x0080,
    0x00CC, 0x0081, 0x0082, 0x0083, 0x00E9, 0x00E6, 0x00E8, 0x00EA, 0x00ED, 0x00EB, 0x00EC,
    0x0084, 0x00EE, 0x00F1, 0x00EF, 0x0085, 0x00CD, 0x00F2, 0x00F4, 0x00F3, 0x0086, 0x00A0,
    0x00A1, 0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00AA, 0x00AB,
    0x00AC, 0x00AD, 0x00AE, 0x00AF, 0x00B0, 0x00B1, 0x00B2, 0x00B3, 0x00B4, 0x00B5, 0x00B6,
    0x00B7, 0x00B8, 0x00B9, 0x00BA, 0x00BB, 0x00BC, 0x00BD, 0x00AE, 0x00AF, 0x00C0, 0x00C1,
    0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC,
    0x00CD, 0x00CE, 0x00CE, 0x00D0, 0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00D7,
    0x00D9, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x00DD, 0x00DE, 0x00DF, 0x00E0, 0x00E1, 0x00E2,
    0x00E3, 0x00E4, 0x00E5, 0x00E6, 0x00E7, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EC, 0x00ED,
    0x00EE, 0x00EF, 0x00F0, 0x00F1, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x00F6, 0x00F7, 0x00F8,
    0x00F9, 0x00FA, 0x00FB, 0x00FC, 0x00FD, 0x00FE, 0x00FF,
    ...
    0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC,
    0x00CD, 0x00CE, 0x00CF, 0x00D0, 0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00D7,
    0x00D8, 0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x00DD, 0x00DE, 0x00DF, 0x00C0, 0x00C1, 0x00C2,
    0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00CC, 0x00CD,
    0x00CE, 0x00CF, 0x00D0, 0x00D1, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D6, 0x00F7, 0x00D8,
    0x00D9, 0x00DA, 0x00DB, 0x00DC, 0x00DD, 0x00FE, 0x00FF,
