...
#endif                     /* _MSL_FLOATING_POINT || _MSL_FLOATING_POINT_IO */
...
typedef union MWVector128 MWVector128;
        ...
        #define vec_va_arg(ap)                                                                 \
            (*(((MWVector128*)(ap = (void*)((((unsigned long)ap + 15) & ‾(15)) + 16))) - 1))
...
/* EJS 021226 */
        ...
        case 'r':
            ...
            if (!f.precision_specified)
                f.precision = 6;
            if (f.argument_options != short_argument && f.argument_options != normal_argument &&
                f.argument_options != long_argument)
                f.conversion_char = bad_conversion;
            break;
    #endif                    /* _MSL_FLOATING_POINT_IO */
    ...
    switch (format.conversion_char)
    {
        ...
        e_format:
            ...
            *--p = format.conversion_char;
            ...
            if (dec.sig.length < format.precision + 1)
                for (n = format.precision + 1 - dec.sig.length + 1; --n;) *--p = '0';
        ...
        f_format:
            ...
            for (digits = 0; digits < (format.precision - frac_digits); ++digits) *--p = '0';

            for (digits = 0; digits < frac_digits && digits < dec.sig.length; ++digits)
                *--p = *--q;

            for (; digits < frac_digits; ++digits) *--p = '0';
            ...
            if (int_digits)
            {
                ...
                for (digits = 0; digits < int_digits - (int)dec.sig.length; ++digits)
                    *--p = '0';
        #else
                for (digits = 0; digits < int_digits - dec.sig.length; ++digits) *--p = '0';
        #endif
...
static int
__pformatter (void*(_MSL_CDECL* WriteProc) (void*, const char*, size_t),
              void*                     WriteProcArg,
              const char* _MSL_RESTRICT format_str,
              va_list                   arg,
              int                       is_secure) /*- mm 990325 -*/ /*- cc 020108 -*/
{
        ...
        do { /* can be done repeatedly for each vector field */
            ...
            switch (format.conversion_char)
            {
...
#endif /* _MSL_LONGLONG */                            /*- mm 961219 -*/
                        if (!(buff_ptr =
                                  long2str (long_num, buff + conversion_buff_size, format)))
                ...
                case 'A':
                    ...
                    if (!(buff_ptr = double2hex (long_double_num,
                                                 buff + conversion_buff_size,
                                                 format)))
                        goto conversion_error;
...
/* EJS 021226 */
                ...
                case 'R':
                    ...
                    if (format.argument_options == short_argument)
                        long_double_num =
                            (unsigned short)va_arg (arg, unsigned long) / (long double)0x10000;
                    else if (format.argument_options == normal_argument)
                        long_double_num =
                            va_arg (arg, unsigned long) / (long double)0x100000000ULL;
                    else
                        long_double_num = va_arg (arg, unsigned long long) /
            ...
            {                                                                 /*- mm 960722 -*/
                fill_char =
                    (format.justification_options == zero_fill) ? '0' : ' ';  /*- mm 960722 -*/
...
void* _MSL_CDECL
__FileWrite (void* File, const char* Buffer, size_t NumChars)                 /*- cc 020108 -*/
{
    return (__fwrite (Buffer, 1, NumChars, (FILE*)File) == NumChars ? File
                                                                    : 0);     /*- mm 040428 -*/
}

void* _MSL_CDECL
__StringWrite (void* osc, const char* Buffer, size_t NumChars)                /*- cc 020108 -*/
{
...
int _MSL_CDECL
printf (const char* _MSL_RESTRICT format, ...)                                /*- cc 010821 -*/
{
    int result;
        ...
        #if defined(__PPC_EABI__) || defined(__MIPS__)
    {
        ...
        #else
    result = __pformatter (&__FileWrite,
                           (void*)stdout,
                           format,
                           __va_start (format),
                           0);                                              /*- mm 001013 -*/
...
int _MSL_CDECL
printf_s (const char* _MSL_RESTRICT format, ...)               /*- cc 010821 -*/
{
    int result;
        ...
        #if defined(__PPC_EABI__) || defined(__MIPS__)
    {
        va_list args;
        va_start (args, format);
        result = __pformatter (&__FileWrite, (void*)stdout, format, args, 1); /*- mm 001013 -*/
    }
        #else
    result = __pformatter (&__FileWrite,
                           (void*)stdout,
...
int
printf_console (const char* format, ...)
{
    int result;
...
int _MSL_CDECL
fprintf (FILE* _MSL_RESTRICT file, const char* _MSL_RESTRICT format, ...)   /*- cc 010821 -*/
{
...
int _MSL_CDECL
fprintf_s (FILE* _MSL_RESTRICT file, const char* _MSL_RESTRICT format, ...)
{
    int result;                                         /*- mm 001013 -*/
    int crtrgn;                                         /*- mm 020627 -*/
...
int _MSL_CDECL
vprintf (const char* _MSL_RESTRICT format, va_list arg)
{
    ...
    retval = __pformatter (&__FileWrite, (void*)stdout, format, arg, 0); /*- mm 001013 -*/
    __end_critical_region (stdout_access); /*- mm 001013 -*/             /*- mm 020627 -*/
    return (retval);                                                     /*- mm 001013 -*/
}

int _MSL_CDECL
vprintf_s (const char* _MSL_RESTRICT format, va_list arg)
{
    int retval;                                                          /*- mm 001013 -*/
...
int _MSL_CDECL
vfprintf (FILE* _MSL_RESTRICT file, const char* _MSL_RESTRICT format, va_list arg)
{
    int retval;                                                          /*- mm 001013 -*/
    int crtrgn;                                                          /*- mm 020627 -*/
#if _MSL_WIDE_CHAR && _MSL_C99                                           /*- mm 030314 -*/
...
int _MSL_CDECL
vfprintf_s (FILE* _MSL_RESTRICT file, const char* _MSL_RESTRICT format, va_list arg)
{
    int retval;                                                          /*- mm 001013 -*/
    int crtrgn;                                                          /*- mm 020627 -*/
    ...
    if (file == stdout)                                                  /*- mm 020627 -*/
        ...
        crtrgn = files_access;                                           /*- mm 020627 -*/
    __begin_critical_region (crtrgn); /*- mm 001013 -*/                  /*- mm 020627 -*/
    retval = __pformatter (&__FileWrite, (void*)file, format, arg, 1);   /*- mm 001013 -*/
    __end_critical_region (crtrgn); /*- mm 001013 -*/                    /*- mm 020627 -*/
    return (retval);                                                     /*- mm 001013 -*/
}

int _MSL_CDECL
vsnprintf (char* _MSL_RESTRICT s, size_t n, const char* _MSL_RESTRICT format, va_list arg)
{
    int          end;
    __OutStrCtrl osc;
...
int _MSL_CDECL
vsnprintf_s (char* _MSL_RESTRICT s, size_t n, const char* _MSL_RESTRICT format, va_list arg)
{
    int          end;
    __OutStrCtrl osc;
...
int _MSL_CDECL
vsprintf (char* _MSL_RESTRICT s, const char* _MSL_RESTRICT format, va_list arg)
{
    return (vsnprintf (s, ULONG_MAX, format, arg));
}

int _MSL_CDECL
vsprintf_s (char* _MSL_RESTRICT s, rsize_t n, const char* _MSL_RESTRICT format, va_list arg)
{
    int retval;
...
int _MSL_CDECL
snprintf (char* _MSL_RESTRICT s, size_t n, const char* _MSL_RESTRICT format, ...)
{
...
int _MSL_CDECL
snprintf_s (char* _MSL_RESTRICT s, rsize_t n, const char* _MSL_RESTRICT format, ...)
{
#if defined(__PPC_EABI__) || defined(__MIPS__) /*- cc 010821 -*/
    {
        va_list args;
...
int _MSL_CDECL
sprintf (char* _MSL_RESTRICT s, const char* _MSL_RESTRICT format, ...)
{
    #if defined(__PPC_EABI__) || defined(__MIPS__)
    {                                          /*- cc 010821 -*/
        va_list args;
...
int _MSL_CDECL
sprintf_s (char* _MSL_RESTRICT s, rsize_t n, const char* _MSL_RESTRICT format, ...)
{
    #if defined(__PPC_EABI__) || defined(__MIPS__)
    {      /*- cc 010821 -*/
        va_list args;
    ...
    return (vsprintf_s (s, n, format, __va_start (format)));
            ...
            * mm  970614 Modifications to remove trailing blanks for g format and to round to nearest or
            *even            mm  970702 Modified Mani's fix to conform to Standard            mm  970708 Inserted Be changes            SCM
            *970709 Converted __va_start() to va_start() for PPC_EABI            mm  970723 Further correction to
            *change of 970206  BW01232            beb 971019 Cleaned up confusing nested if statements            mf  971020
            *found another bad if block under long long support            FS  980113 Converted __va_start() to
            *va_start() for MIPS_bare            mm  980206 Added wide-character support            BLC 980301 added vsnprintf,
            *snprintf functions            BLC 980309 added format string support for 'll' and 'hh' type mods from C9X
            ...
            * mm  990208 Change to make %lE, %le, %lG, and %lg be accepted but ignore the l (C9x
            *Clause 7.13.6.1 para #3)            mm  990317 ReCorrected placement of null char in result of vsnprintf
            *to match C9x (IL9903-1264)            mm  990325 Modified to make split between string functions andfile
            *i/o            mm  990430 Added code for %F in accordance with C9x            mm  990430 Brought printing of inf
            *into line with C9x            vss 990624 Added NO_WIDE_CHAR wrappers            mm  990430 Brought printing of nan
            *into line with C9x            mm  990817 Deleted include of <string_io.h>            mm  990722 Added code for %a %A
            ...
            *C99 functions            ejs 021002 Fix little-endian and portability bugs in doubletohex()            cc  021004
            *Added _MSL_C_LOCALE_ONLY            ejs 021009 Make hex float printing really independent of 64-bit
            *double format            JWW 021031 Made thread local data available for Mach-O            ejs 021226 Added
            *%hR,%R,%lR,%hr,%r,%lr for e500 SPE PIM            mm  030218 Added some C99 wrappers            JWW 030224 Changed
            *__MSL_LONGLONG_SUPPORT__ flag into the new more configurable _MSL_LONGLONG            JWW 030224 Changed
            *__NO_WIDE_CHAR flag into the new more configurable _MSL_WIDE_CHAR            mm  030304 Added some more
            *C99 wrappers            mm  030314 And more _MSL_C99 wrappers            mm  030422 Modifications to print the value
            *zero under %a and %A with a zero exponent for C99            ejs 030627 Fix bug in %hh specifier with
            *signed argument (use "signed char", not "char" conversion)            mm  030924 Fix to correct action of
            *vsnprintf() invoked with n=0.  Thanks to Bogdan Marinescu            cc  040217 Changed
            *_No_Floating_Point to _MSL_FLOATING_POINT            cc  040217 Changed _No_Disk_File_OS_Support to
            *_MSL_OS_DISK_FILE_SUPPORT            mm  040428 Change to call __fwrite instead of fwrite to avoid nested
            *critical regions.            mm  040811 Changes to correct handling arguments of type intmax_t  MTWX14449
