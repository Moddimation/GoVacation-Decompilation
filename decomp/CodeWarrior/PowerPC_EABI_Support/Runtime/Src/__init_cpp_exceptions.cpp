...
/***************************************************************************/
extern void
__exception_info_constants (void** info, char** R2)
{
 ...
 *info ex_end		address of variable to hold end address of exception
 *table info
 *
 *	we now overload the function in the event that the user wants pic pid
 *
...
/***************************************************************************/
extern int
__find_exception_addresses (void* info, char* returnaddr, void** ex_start, void** ex_end)
{
