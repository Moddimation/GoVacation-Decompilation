...
_MSL_IMP_EXP_C double _MSL_CDECL wcstod (const wchar_t* _MSL_RESTRICT,
                                         wchar_t**      _MSL_RESTRICT) _MSL_CANT_THROW;
_MSL_IMP_EXP_C float _MSL_CDECL  wcstof (const wchar_t* _MSL_RESTRICT, wchar_t** _MSL_RESTRICT)
    _MSL_CANT_THROW;                                                 /*- mm 021112 -*/
_MSL_IMP_EXP_C long double _MSL_CDECL wcstold (const wchar_t* _MSL_RESTRICT,
