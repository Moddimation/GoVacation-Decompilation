...
int _MSL_CDECL
_wrename (const wchar_t* old_name, const wchar_t* new_name)
{
    return ((__wrename_file (old_name, new_name) == __no_io_error) ? 0 : -1);
}

wchar_t* _MSL_CDECL
_wtmpnam (wchar_t* name)
{
            /*- BLC 991210 -*/
...
errno_t _MSL_CDECL
_wtmpnam_s (wchar_t* name, rsize_t maxsize)
{
...
FILE* _MSL_CDECL
_wfopen (const wchar_t* _MSL_RESTRICT name, const wchar_t* _MSL_RESTRICT mode)
{
    FILE* file;
...
errno_t _MSL_CDECL
_wfopen_s (FILE* _MSL_RESTRICT* _MSL_RESTRICT file,
           const wchar_t* _MSL_RESTRICT       name,
           const wchar_t* _MSL_RESTRICT       mode)
{
    FILE* newfile;
...
FILE* _MSL_CDECL
_wfreopen (const wchar_t* _MSL_RESTRICT name,
           const wchar_t* _MSL_RESTRICT mode,
...
errno_t _MSL_CDECL
_wfreopen_s (FILE* _MSL_RESTRICT* _MSL_RESTRICT newfile,
             const wchar_t* _MSL_RESTRICT       name,
             const wchar_t* _MSL_RESTRICT       mode,
             FILE* _MSL_RESTRICT                file)
{
...
FILE* _MSL_CDECL
__whandle_open (__file_handle handle, const wchar_t* mode)
{
    FILE* file;
...
FILE* _MSL_CDECL
__whandle_reopen (__file_handle handle, const wchar_t* mode, FILE* file)
{
    __file_modes modes;
...
int _MSL_CDECL
__wget_file_modes (const wchar_t* mode, __file_modes* modes)
{
