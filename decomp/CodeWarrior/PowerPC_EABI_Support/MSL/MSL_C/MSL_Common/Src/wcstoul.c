...
unsigned long _MSL_CDECL
wcstoul (const wchar_t* _MSL_RESTRICT str, wchar_t** _MSL_RESTRICT end, int base)
{
    unsigned long value;
    ...
    value =
        __wcstoul (base, INT_MAX, &__wStringRead, (void*)&wisc, &count, &negative, &overflow);
    ...
    return (value);
        ...
        #if (_MSL_LONGLONG && _MSL_C99) /*- mm 970110 -*/ /*- mm 030225 -*/
unsigned long long _MSL_CDECL
wcstoull (const wchar_t* _MSL_RESTRICT str, wchar_t** _MSL_RESTRICT end, int base)
{
    ...
    value =
        __wcstoull (base, INT_MAX, &__wStringRead, (void*)&wisc, &count, &negative, &overflow);
...
long _MSL_CDECL
wcstol (const wchar_t* _MSL_RESTRICT str, wchar_t** _MSL_RESTRICT end, int base)
{
...
wcstoll (const wchar_t* _MSL_RESTRICT str, wchar_t** _MSL_RESTRICT end, int base)
{
