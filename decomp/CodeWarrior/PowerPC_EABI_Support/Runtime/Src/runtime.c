...
_savevr (void)
{
    nofralloc machine altivec
        ...
        -176 stvx v21, r12, r0 ENTRY_SAVE_VPR (22) ENTRY_SAVE_VPR2 (22) addi r12, r0,
        -160 stvx v22, r12, r0 ENTRY_SAVE_VPR (23) ENTRY_SAVE_VPR2 (23) addi r12, r0,
        -144 stvx v23, r12, r0 ENTRY_SAVE_VPR (24) ENTRY_SAVE_VPR2 (24) addi r12, r0,
        -128 stvx v24, r12, r0 ENTRY_SAVE_VPR (25) ENTRY_SAVE_VPR2 (25) addi r12, r0,
        -112 stvx v25, r12, r0 ENTRY_SAVE_VPR (26) ENTRY_SAVE_VPR2 (26) addi r12, r0,
        -96 stvx v26, r12, r0 ENTRY_SAVE_VPR (27) ENTRY_SAVE_VPR2 (27) addi r12, r0,
        -80 stvx v27, r12, r0 ENTRY_SAVE_VPR (28) ENTRY_SAVE_VPR2 (28) addi r12, r0,
        -64 stvx v28, r12, r0 ENTRY_SAVE_VPR (29) ENTRY_SAVE_VPR2 (29) addi r12, r0,
        -48 stvx v29, r12, r0 ENTRY_SAVE_VPR (30) ENTRY_SAVE_VPR2 (30) addi r12, r0,
        -32 stvx v30, r12, r0 ENTRY_SAVE_VPR (31) ENTRY_SAVE_VPR2 (31) addi r12, r0,
        -16 stvx v31, r12, r0 blr
}
    #endif
...
__save64_gpr (void)
{
    ...
    nofralloc
        ...
        128(save_restore_reg)ENTRY_SAVE64_GPR (31) evstdd r31, 136(save_restore_reg)blr
}
...
__restore_gpr (void)
{
    ...
    nofralloc
        ...
        -72(save_restore_reg)ENTRY_RESTORE_GPR (15) ENTRY_RESTORE32_GPR (15) lwz r15,
        -68(save_restore_reg)ENTRY_RESTORE_GPR (16) ENTRY_RESTORE32_GPR (16) lwz r16,
        -64(save_restore_reg)ENTRY_RESTORE_GPR (17) ENTRY_RESTORE32_GPR (17) lwz r17,
        -60(save_restore_reg)ENTRY_RESTORE_GPR (18) ENTRY_RESTORE32_GPR (18) lwz r18,
        -56(save_restore_reg)ENTRY_RESTORE_GPR (19) ENTRY_RESTORE32_GPR (19) lwz r19,
        -52(save_restore_reg)ENTRY_RESTORE_GPR (20) ENTRY_RESTORE32_GPR (20) lwz r20,
        -48(save_restore_reg)ENTRY_RESTORE_GPR (21) ENTRY_RESTORE32_GPR (21) lwz r21,
        -44(save_restore_reg)ENTRY_RESTORE_GPR (22) ENTRY_RESTORE32_GPR (22) lwz r22,
        -40(save_restore_reg)ENTRY_RESTORE_GPR (23) ENTRY_RESTORE32_GPR (23) lwz r23,
        -36(save_restore_reg)ENTRY_RESTORE_GPR (24) ENTRY_RESTORE32_GPR (24) lwz r24,
        -32(save_restore_reg)ENTRY_RESTORE_GPR (25) ENTRY_RESTORE32_GPR (25) lwz r25,
        -28(save_restore_reg)ENTRY_RESTORE_GPR (26) ENTRY_RESTORE32_GPR (26) lwz r26,
        -24(save_restore_reg)ENTRY_RESTORE_GPR (27) ENTRY_RESTORE32_GPR (27) lwz r27,
        -20(save_restore_reg)ENTRY_RESTORE_GPR (28) ENTRY_RESTORE32_GPR (28) lwz r28,
        -16(save_restore_reg)ENTRY_RESTORE_GPR (29) ENTRY_RESTORE32_GPR (29) lwz r29,
        -12(save_restore_reg)ENTRY_RESTORE_GPR (30) ENTRY_RESTORE32_GPR (30) lwz r30,
...
__restore64_gpr (void)
{
    ...
    nofralloc
        ...
        128(save_restore_reg)ENTRY_RESTORE64_GPR (31) evldd r31, 136(save_restore_reg)blr
}
    #endif // __SPE__
...
__shr2i (void)
{
    ...
    nofralloc
        ...
        subfic r8,
        r5, 32 subic.r9, r5, 32 srw LSW (r3, r4), LSW (r3, r4), r5 slw r10, MSW (r3, r4),
        r8 or LSW (r3, r4), LSW (r3, r4), r10 sraw r10, MSW (r3, r4),
