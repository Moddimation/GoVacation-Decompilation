...
_MSL_IMP_EXP_C unsigned long _MSL_CDECL wcstoul (const wchar_t* _MSL_RESTRICT,
                                                 wchar_t**      _MSL_RESTRICT,
                                                 int) _MSL_CANT_THROW;
        #if _MSL_C99
            #if _MSL_LONGLONG
_MSL_IMP_EXP_C unsigned long long _MSL_CDECL wcstoull (const wchar_t* _MSL_RESTRICT,
                                                       wchar_t**      _MSL_RESTRICT,
                                                       int) _MSL_CANT_THROW;
_MSL_IMP_EXP_C long long _MSL_CDECL          wcstoll (const wchar_t* _MSL_RESTRICT,
                                                      wchar_t**      _MSL_RESTRICT,
                                                      int) _MSL_CANT_THROW;
            #endif                                                  /* _MSL_LONGLONG */
        #endif                                                               /* _MSL_C99 */
_MSL_IMP_EXP_C long _MSL_CDECL wcstol (const wchar_t* _MSL_RESTRICT,
                                       wchar_t**      _MSL_RESTRICT,
                                       int) _MSL_CANT_THROW;
