...
_MSL_END_EXTERN_C
        ...
        #define __msl_walnum  (__msl_walpha | __msl_wdigit)
                       ...
                       * JWW 020305 Recoded ctype map to use shorts instead of wchar_ts and define map bits
                       * appropriately                       JWW 020308 Explicitly define table sizes and remove the unnecessary zero-fill
                       * macro                       cc  020521 Added const keyword for platforms with limited RAM space                       cc  021001 Added
                       * support for _MSL_C_LOCALE_ONLY                       JWW 030224 Changed __NO_WIDE_CHAR flag into the new more
                       * configurable _MSL_WIDE_CHAR
                       */
