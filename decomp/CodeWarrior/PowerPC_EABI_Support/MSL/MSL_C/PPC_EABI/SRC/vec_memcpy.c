...
// that don't, make sure VRSAVE is undefined.
      ...
      mfspr RSV,
                               ...
                               VP2 // VPU D0 select vector for dst left; src right
                                   ...
                                   // If DN destination is right justified this load is not
                                   // required; unconditionalized for speed.
                                       lvx VDN,
                               DST,
      ...
      :                           // Come here with QW>=10 and next store even; VS0 last load
        ...
        B32_fwd                   // b if DST[27] == 0; i.e, final store is even
            ...
            bdnz B32_fwd          // b and decrement counter for last QW store odd
                ...
                // bcopy works like memcpy, but the source and destination operands are
                // reversed. Following will just reverse the operands and branch to memcpy.
