...
_MSL_IMP_EXP_C float atan2f
_MSL_MATH_CDECL (float y, float x)
{
    return atan (y / x);
}

_MSL_IMP_EXP_C float asinf
_MSL_MATH_CDECL (float x)
{
    return atan (x * (1.0f / sqrtf (1.0f - x * x))); /* note if |x| > 1 a quiet NaN will be
                                                        returned via the sqrtf function */
}
    #endif /* __MIPS__ && __MIPS_ISA4__  && __MIPS_single_fpu__ */

_MSL_IMP_EXP_C float atanf
_MSL_MATH_CDECL (float x)
{
    float     z, z_square;
    int       index = -1, inv = 0;
    ...
    static const float atan_coeff[] = { .999999999f,    -.3333333213f, .19999886356f,
                                        -.14281650536f, .11041179874f, -.084597554152f,
                                        .04714243524f /*.76f */ };
    ...
    static const float onep_one_over_xisqr_hi[] = { 6.82842f,    3.239828f,
                                                    2.0f,      /*   6.828427125f  */
                                                    1.446462f,   1.17157292f,
                                                    1.039566130f };

    static const float onep_one_over_xisqr_lo[] = { .000007135f, 0.00000082f, .0f,
                                                    0.00000063f, 0.0f,        0.0f };

    static const float atan_xi_hi[]             = { 0.0f,      .39269f,   .5890486f,
                                                    .7853981f, /* .3926990817f  */
                                                    .981747f,  1.178097f, 1.374446f };
    static const float atan_xi_lo[]             = { 0.0f,        .000009081698724f, .000000023f,
                                                    .000000063f, .000000704f,       .00000025f,
                                                    .00000079f };
    ...
    z +=
        ...
        (atan_coeff[1] +
         z_square *
             (atan_coeff[2] +
              z_square * (atan_coeff[3] +
                          z_square * (atan_coeff[4] +
