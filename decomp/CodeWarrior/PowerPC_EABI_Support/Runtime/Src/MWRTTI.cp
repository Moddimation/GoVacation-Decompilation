...
/*	Name......:	MWRTTI.cp																	*/
/*	Purpose...:	RTTI																		*/
/*  Copyright.: Copyright ｩ 1993-2006 Freescale Semiconductor, Inc.  All rights reserved.   */
/*  $Date: 2006/02/18 00:03:58 $                                                            */
/*  $Revision: 1.7 $                                                      					*/
/********************************************************************************************/
...
_MSL_IMP_EXP_RUNTIME void* __dynamic_cast (void*,
                                           long,
                                           type_info_struct*,
                                           type_info_struct*,
                                           short);
                ...
                short             isref)
{
    ...
    {                                   //	class was compiled with the RTTI option
        ...
        if ((list = vthead->type_info_ptr->baselist) != 0)
            for (; list->baseti; list++)
            {                           //	check base classes
...
//  hh 980124 type_info implementation moved to <typeinfo>
// JWW 000418 export __get_typeid and __dynamic_cast data items to remove dependency on the .exp
// file
