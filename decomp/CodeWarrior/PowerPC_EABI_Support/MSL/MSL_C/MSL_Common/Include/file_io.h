...
_MSL_IMP_EXP_C int _MSL_CDECL __get_file_modes (const char* mode,
                                                __std (__file_modes) * modes) _MSL_CANT_THROW;
    #endif                                                     /* _MSL_OS_DISK_FILE_SUPPORT */

    #if _MSL_WFILEIO_AVAILABLE
int _MSL_CDECL                __wopen_file (const wchar_t* name,
                                            __std (__file_modes) mode,
                                            __std (__file_handle) * handle) _MSL_CANT_THROW;
...
int _MSL_CDECL                __wrename_file (const wchar_t* old_name,
                                              const wchar_t* new_name) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_CDECL __wget_file_modes (const wchar_t* mode,
                                                 __std (__file_modes) * modes) _MSL_CANT_THROW;
