...
__declspec (weak) extern void* const __destroy_global_chain_reference = __destroy_global_chain;
#endif /* __MWERKS__ && __PPC_EABI__ && __dest_os!=__eppc_vxworks */
...
int _MSL_CDECL
__register_atexit (void (*func) (void))
{
