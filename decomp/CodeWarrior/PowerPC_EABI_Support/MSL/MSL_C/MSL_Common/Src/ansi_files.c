...
FILE __files[_STATIC_FILES] = /*- mm 961031 -*/ /*- mm 961203 -*/ /*- mm 981007 -*/
 ...
 __write,                              /* io_mode   */
 _IONBF,
 /* buffer_mode */ /*- Mani 970101 -*/ /*- mm 970708 -*/
 #if _MSL_CONSOLE_FILE_IS_DISK_FILE
 __disk_file,
 #else
            __console_file,             /* file_kind   */
...
void _MSL_CDECL
__init_file (FILE* file, __file_modes mode, char* buff, size_t size)
{
    file->handle            = 0;
    file->mode              = mode;
...
int _MSL_CDECL
__flush_line_buffered_output_files (void)
{
    int   result = 0;
    FILE* p      = &__files[0];  /*- mm 981007 -*/
    ...
    while (p != NULL)            /*- mm 981007 -*/
    {
        if (p->mode.file_kind != __closed_file && (p->mode.buffer_mode & _IOLBF) &&
...
__flush_all (void)
{
    ...
    return (result);
                                  ...
                                  * mm  981015 Commented out __file_to_num and __num_to_file while investigating whether they are
                                  *really needed.                                  mm  981020 Corrections to dynamic file structures changes for
                                  *_No_Disk_File_OS_Support                                  mea 981023 re-added the console_buff_mode.  Please see
                                  *ansi_prefix.PPCEABI.bare.h                                  mm  981029 Changed __DSP568 to __m56800__                                  mf  990117 added include
                                  *of stdlib.h/string.h for malloc,memset prototypes                                  ad  990128 Added No_Console wrappers                                  mm
                                  *990816 Deleted references to __string_file                                  mm  990817 Deleted include of <string_io.h>                                  mm
                                  *000406 Corrected setting of stream->handle for Mac stdin, stdout, stderr                                  mm  010115 Corrected
                                  *handling of No_Console case                                  ah  010121 now uses dsp hostio define for hawk2 R1 and the dual
                                  *target MSL project                                  and hawk1 transitional MSL -- see ansi_parms.h.                                  mm  010322 Made linking
                                  *possible with No_Console defined.                                  cc  010924 Moved _Unbuffered_Console defines from source
                                  *file to header                                  cc  011203 Added _MSL_CDECL for new name mangling                                  JWW 020906 Use generic
                                  *reference constant instead of specific idle_proc in file I/O                                  JWW 030224 Changed __NO_WIDE_CHAR
                                  *flag into the new more configurable _MSL_WIDE_CHAR                                  cc  040217 Changed _No_Disk_File_OS_Support
                                  *to _MSL_OS_DISK_FILE_SUPPORT                                  JWW 040405 Added new flexible console configuration flags                                  mm
                                  *040429 Changes to avoid nesting of critical regions
                                  */
