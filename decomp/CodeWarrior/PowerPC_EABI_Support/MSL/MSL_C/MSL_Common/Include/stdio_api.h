...
_MSL_IMP_EXP_C size_t _MSL_CDECL __fread (void*, size_t, size_t, FILE*)
    _MSL_CANT_THROW; /*- mm 001018 -*/
_MSL_IMP_EXP_C size_t _MSL_CDECL __fwrite (const void*, size_t, size_t, FILE*)
    _MSL_CANT_THROW; /*- mm 001018 -*/
...
void* _MSL_CDECL __wStringWrite (void*,
                                 const wchar_t*,
                                 size_t) _MSL_CANT_THROW;                      /*- cc 020108 -*/
...
_MSL_IMP_EXP_C FILE* _MSL_CDECL __handle_open (__file_handle handle,
                                               const char*   mode) _MSL_CANT_THROW;
FILE* _MSL_CDECL                __handle_reopen (__file_handle handle,
                                                 const char*   mode,
                                                 FILE*) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C FILE* _MSL_CDECL __whandle_open (__file_handle  handle,
                                                const wchar_t* mode) _MSL_CANT_THROW;
FILE* _MSL_CDECL                __whandle_reopen (__file_handle  handle,
                                                  const wchar_t* mode,
                                                  FILE*) _MSL_CANT_THROW;
