...
/*#pragma overload int __read_console(__file_handle handle, unsigned char * buffer, size_t *
 * count, __idle_proc idle_proc);*/

int
__read_console (__file_handle handle, unsigned char* buffer, size_t* count, __ref_con ref_con)
{
