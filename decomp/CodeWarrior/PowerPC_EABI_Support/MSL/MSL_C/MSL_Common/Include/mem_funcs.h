...
void _MSL_CDECL __copy_longs_aligned (void*         dst,
                                      const void*   src,
                                      unsigned long n) _MSL_CANT_THROW;
void _MSL_CDECL __copy_longs_rev_aligned (void*         dst,
                                          const void*   src,
                                          unsigned long n) _MSL_CANT_THROW;
void _MSL_CDECL __copy_longs_unaligned (void*         dst,
                                        const void*   src,
                                        unsigned long n) _MSL_CANT_THROW;
void _MSL_CDECL __copy_longs_rev_unaligned (void*         dst,
                                            const void*   src,
                                            unsigned long n) _MSL_CANT_THROW;
