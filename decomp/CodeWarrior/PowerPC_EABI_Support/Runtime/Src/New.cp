...
/*  Copyright.: Copyright ｩ 1993-2000 Metrowerks, Corporation.          */
/*  $Date: 2011/02/17 22:33:19 $                                                            */
/*  $Revision: 1.8.6.1 $                                                        */
/************************************************************************/
...
__declspec (weak) extern void* operator new (_CSTD::size_t) _MSL_THROW_BAD_ALLOC;
#ifndef _MSL_NO_EXCEPTIONS
__declspec (weak) extern void* operator new (_CSTD::size_t, const _STD::nothrow_t&) _MSL_THROW;
#endif
__declspec (weak) extern void operator delete (void*) _MSL_THROW;

#if __MWERKS__ >= 0x2020
__declspec (weak) extern void* operator new[] (_CSTD::size_t) _MSL_THROW_BAD_ALLOC;
    #ifndef _MSL_NO_EXCEPTIONS
__declspec (weak) extern void* operator new[] (_CSTD::size_t,
...
__declspec (weak) extern void operator delete[] (void*) _MSL_THROW;
    ...
    #ifndef _MSL_NO_EXCEPTIONS
__declspec (weak) extern void operator delete (void*, const _STD::nothrow_t&) _MSL_THROW;
__declspec (weak) extern void operator delete[] (void*, const _STD::nothrow_t&) _MSL_THROW;
    #endif
#endif
...
OPERATOR_NEW (_CSTD::size_t size) _MSL_THROW_BAD_ALLOC
{
    ...
    // sw 09202002 - removed any instance of __MODENALIB__
    // changed default alloc to 1 as per Howard Hinnant's instructions
    ...
    for (;;)
    {
        ...
        // sw 09202002 - new is now sensitive to C++
        // exceptions being enabled / disabled
...
// hh 971208 Changed sizeof(1) to sizeof(int)
// hh 980121 commented out Debug_New dance.  #define new to anything at your own risk!  Not
// recommended! hh 980124 added nothrow Hsoi 980819 Modified array new and delete to use
// redefinition macros for DebugNew support Hsoi 990121 Fixed incorrect placement of OPERATOR
// #defines wrt __MWERKS__ version check. bds 990322 ifdefed MacOS-specific code so this
// compiles on BeOS ra 000107 Updated for Universal Interfaces 3.3.1 bobc 000114 Fixed MW09304.
