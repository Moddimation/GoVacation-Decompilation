...
void _MSL_CDECL __init_file (__std (FILE) *,
                             __std (__file_modes) mode,
                             char* buff,
                             __std (size_t)) _MSL_CANT_THROW; /*- mf 990715 -*/
...
_MSL_END_EXTERN_C
                                                               ...
                                                               * really needed.                                                               mm  990121 fixed __std 6 places                                                               blc 990308 fixed tabbing on macro definitions
