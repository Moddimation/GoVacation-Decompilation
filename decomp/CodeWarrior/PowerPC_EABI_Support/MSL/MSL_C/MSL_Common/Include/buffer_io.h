...
void _MSL_CDECL __convert_from_newlines (unsigned char* p,
                                         __std (size_t) * n) _MSL_CANT_THROW; /*- hh 990121 -*/
...
int _MSL_CDECL  __load_buffer (__std (FILE) *,
                               __std (size_t) * bytes_loaded,
                               int alignment) _MSL_CANT_THROW;                /*- mf 990715 -*/
int _MSL_CDECL  __flush_buffer (__std (FILE) *,
                                __std (size_t) *
                                    bytes_flushed) _MSL_CANT_THROW;           /*- mf 990715 -*/
