...
exp2 (double x) _MSL_CANT_THROW
{
    ...
    return (exp (x * _ln2));
            ...
            #if !defined(__arm)
_MSL_IMP_EXP_C long long _MSL_MATH_CDECL
llrint (double x) _MSL_CANT_THROW
{
    return ((long long)rint (x));
}
            #endif /* !defined(__arm) */

_MSL_IMP_EXP_C long long int _MSL_MATH_CDECL
llround (double num)
{
...
llroundl (long double num)
{
    ...
    return (result);
            ...
            #if !defined(__arm)
_MSL_IMP_EXP_C long int _MSL_MATH_CDECL
lrint (double num)
{
    long int result = 0;
    int      neg    = 0;
