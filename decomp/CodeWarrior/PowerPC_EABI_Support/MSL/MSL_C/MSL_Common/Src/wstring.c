...
*/
size_t
_MSL_CDECL (wcslen) (const wchar_t* str)
{
    size_t len = -1;
...
size_t
_MSL_CDECL (wcsnlen_s) (const wchar_t* str, size_t maxsize)
{
    wchar_t* end;
    wchar_t* p;
    size_t   len = -1;
...
wchar_t*
_MSL_CDECL (wcscpy) (wchar_t* _MSL_RESTRICT dst, const wchar_t* _MSL_RESTRICT src)
{
    #if !defined(__POWERPC__)
...
errno_t
_MSL_CDECL (wcscpy_s) (wchar_t* _MSL_RESTRICT       dst,
                       rsize_t                      dst_max,
                       const wchar_t* _MSL_RESTRICT src)
{
    if ((dst_max == 0) || (dst == NULL) || (src == NULL) || (dst_max == 0) ||
        (dst_max > RSIZE_MAX))
    {
...
wchar_t* _MSL_CDECL
wcsncpy (wchar_t* _MSL_RESTRICT dst, const wchar_t* _MSL_RESTRICT src, size_t n)
{
    #if !defined(__POWERPC__)
...
errno_t _MSL_CDECL
wcsncpy_s (wchar_t* _MSL_RESTRICT       dst,
           rsize_t                      dst_max,
           const wchar_t* _MSL_RESTRICT src,
           rsize_t                      n)
{
...
wchar_t* _MSL_CDECL
wcscat (wchar_t* _MSL_RESTRICT dst, const wchar_t* _MSL_RESTRICT src)
{
    #if !defined(__POWERPC__)
...
errno_t (wcscat_s) (wchar_t* _MSL_RESTRICT       dst,
                    rsize_t                      dst_max,
                    const wchar_t* _MSL_RESTRICT src)
{
    rsize_t dst_cat_max;
...
wchar_t* _MSL_CDECL
wcsncat (wchar_t* _MSL_RESTRICT dst, const wchar_t* _MSL_RESTRICT src, size_t n)
{
    #if !defined(__POWERPC__)
...
errno_t _MSL_CDECL
wcsncat_s (wchar_t* _MSL_RESTRICT       dst,
           rsize_t                      dst_max,
           const wchar_t* _MSL_RESTRICT src,
           rsize_t                      n)
{
...
size_t _MSL_CDECL
wcsxfrm (wchar_t* _MSL_RESTRICT str1, const wchar_t* _MSL_RESTRICT str2, size_t n)
{
...
/* Code deleted here mm 010316  The version of wcstok for Windows made use of the thread-local
   data belonging to strtok, which breaks the requirement that strtok behave as if no other
   library function calls it.  Further, the Standards committe learnt from its experience with
   strtok that requiring a state that the library had to look after was a bad thing and so they
   gave wcstok an extra parameter so that thread-local storage is no longer needed for it. */

wchar_t* _MSL_CDECL
wcstok (wchar_t* _MSL_RESTRICT       str,
        const wchar_t* _MSL_RESTRICT set,
        wchar_t** _MSL_RESTRICT      ptr)                          /*- mm 000422 -*/
{
    wchar_t *       p, *q;
...
wcsstr (const wchar_t* str, const wchar_t* pat)
{
    ...
    #pragma warn_possunwant reset
                                 ...
                                 * ejs 020219 Removed _MSL_TLS from wcstok: this implementation does not need thread-local
                                 storage
