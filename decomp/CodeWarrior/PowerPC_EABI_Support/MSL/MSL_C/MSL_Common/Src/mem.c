...
void*(memcpy)(register void* _MSL_RESTRICT       dst,
              register const void* _MSL_RESTRICT src,
              register size_t                    n)
{
    ...
    char*       q = (char*)dst;
                    ...
                    !defined(__COLDFIRE__) && !defined(__arm) && !defined(__m56800__) &&       \
...
errno_t (memcpy_s) (register void* _MSL_RESTRICT       dst,
                    register rsize_t                   dst_max,
                    register const void* _MSL_RESTRICT src,
                    register rsize_t                   n)
{
...
errno_t (memmove_s) (void* dst, rsize_t dst_max, const void* src, rsize_t n)
{
    ...
    return ENOERR;
                                       ...
                                       *specifications                                       JWW 040831 Obtain fast Mach-O versions of memcpy, memmove, etc. from the
                                       *System.framework                                       cc  041110 Added _MSL_LONG_COPY_MIN macro
                                       */
